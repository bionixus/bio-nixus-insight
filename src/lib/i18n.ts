...
export const translations = {
  en: {
    ...
    contact: {
      ...
      validation: {
        ...
        businessEmail: 'Please use a business/company email only. Personal addresses (Gmail, Yahoo, Outlook, and similar) are not accepted.',
  ...
  de: {
    ...
    contact: {
      ...
      validation: {
        ...
        businessEmail: 'Bitte verwenden Sie ausschließlich eine geschäftliche E-Mail-Adresse. Private Adressen (Gmail, Yahoo, Outlook u. Ä.) werden nicht akzeptiert.',
  ...
  fr: {
    ...
    contact: {
      ...
      validation: {
        ...
        businessEmail: 'Veuillez utiliser uniquement une adresse e-mail professionnelle. Les adresses personnelles (Gmail, Yahoo, Outlook, etc.) ne sont pas acceptées.',
  ...
  es: {
    ...
    contact: {
      ...
      validation: {
        ...
        businessEmail: 'Utilice únicamente un correo electrónico de empresa. No se aceptan direcciones personales (Gmail, Yahoo, Outlook y similares).',
  ...
  zh: {
    ...
    contact: {
      ...
      validation: {
        ...
        businessEmail: '请使用公司/企业邮箱。不接受个人邮箱（Gmail、Yahoo、Outlook 等）。',
        success: '您的咨询已成功提交！',
  ...
  ar: {
    ...
    contact: {
      ...
      validation: {
        ...
        businessEmail: 'يرجى استخدام بريد إلكتروني للعمل أو الشركة فقط. لا تُقبل عناوين البريد الشخصية (Gmail وYahoo وOutlook وما شابه).',
  ...
  pt: {
    ...
    insights: {
      ...
      items: [
        {
          category: 'Acesso ao Mercado',
          title: 'O futuro dos acordos de saúde baseados em valor na Europa',
          excerpt: 'Como modelos inovadores de contratação estão a reformular precificação e acesso farmacêutico nos principais mercados europeus.',
          date: 'Relatório T4 2024',
        },
        {
          category: 'Saúde Digital',
          title: 'Descoberta de fármacos com IA: implicações de mercado',
          excerpt: 'Análise da mudança competitiva à medida que a inteligência artificial transforma I&D farmacêutica e o tempo até ao mercado.',
          date: 'Brief estratégico',
        },
        {
          category: 'Oncologia',
          title: 'Dinâmica do mercado de medicina de precisão 2025',
          excerpt: 'Análise abrangente de terapias guiadas por biomarcadores e do paradigma em evolução do tratamento oncológico.',
    ...
    contactPage: {
      brandLine: 'BioNixus',
      heroTitle: 'Fale com uma equipa global de pesquisa de mercado.',
      heroSubtitle:
        'A BioNixus é uma empresa global de pesquisa de mercado com experiência sólida em EMEA, Américas e APAC — sobretudo em saúde, farma, B2B e B2C. Partilhe o brief e receba uma proposta delimitada, normalmente num dia útil.',
    ...
    contact: {
      ...
      messagePlaceholder: 'Descreva as suas necessidades de pesquisa...',
      successTitle: 'Obrigado!',
      successBody: 'A sua mensagem foi enviada. A nossa equipa responderá em breve.',
      successCaseStudiesText: 'casos de estudo',
      successMethodologyText: 'metodologia',
      successFollowUpIntro: 'Explore os nossos ',
      successFollowUpBetween: ' ou a ',
      successFollowUpEnd: ' entretanto.',
      validation: {
        firstName: 'Indique o seu nome',
        lastName: 'Indique o seu apelido',
        workEmail: 'Indique um e-mail profissional válido',
        company: 'Indique o nome da empresa',
        country: 'Selecione o país ou região',
        message: 'Descreva como podemos ajudar',
        privacy: 'Aceite a política de privacidade',
        emailFormat: 'Indique um endereço de e-mail válido',
        businessEmail: 'Utilize apenas um e-mail profissional/empresarial. Endereços pessoais (Gmail, Yahoo, Outlook e semelhantes) não são aceites.',
        phoneFormat: 'Indique um número de telefone válido',
        success: 'A sua mensagem foi enviada!',
        error: 'Algo correu mal. Tente novamente ou contacte-nos por e-mail.',
      },
    },
    contactHomeEmbed: {
    ...
    localePrompt: {
      title: 'Está a abrir a partir de {region}.',
      question: 'Quer mudar para {language}?',
      yes: 'Sim',
      no: 'Não',
    },
    footer: {
    ...
    caseStudiesPage: {
      ...
      subtitle: 'Casos europeus e exemplos de projeto. Peça acesso para ver os PDF completos.',
      requestAccess: 'Pedir acesso',
      requestAccessTitle: 'Indique os seus dados para ver este caso de estudo',
      subscribeToContinue: 'Subscreva para continuar a ler',
      subscribeToContinueTitle: 'Indique os seus dados para ver o resto deste caso de estudo',
      viewCaseStudy: 'Ver caso de estudo',
      noCaseStudies: 'Ainda não há casos de estudo.',
      filterByTopic: 'Tema',
      filterByCountry: 'País',
      filterAllTopics: 'Todos os temas',
      filterAllCountries: 'Todos os países',
      ...
      close: 'Fechar',
      pdfViewerTitle: 'Caso de estudo',
      optional: 'Opcional',
      previousSlide: 'Anterior',
      nextSlide: 'Seguinte',
      slideOf: 'Diapositivo {current} de {total}',
  ...
  ru: {
    ...
    contact: {
      ...
      validation: {
        ...
        businessEmail: 'Используйте только рабочий/корпоративный адрес электронной почты. Личные адреса (Gmail, Yahoo, Outlook и аналогичные) не принимаются.',
    ...
    localePrompt: {
      title: 'Вы открываете сайт из региона {region}.',
      question: 'Переключиться на {language}?',
      yes: 'Да',
      no: 'Нет',
    },
    footer: {
