...
const rawReportZeroLinkPaths = [
  ...
  '/blog/mercado-farmaceutico-brasil-guia-anvisa-2026',
  ...
  '/blog/pesquisa-mercado-farmaceutico-brasil-2026',
...
const redirectAliasPaths = new Set([
  ...
  '/market-research/medtech',
  '/market-research/consumer-health',
  '/market-reports/uae-medical-devices-market-report',
  '/top-market-research-companies-brazil-2026',
  '/global-websites',
  '/ar/conf',
  '/ar/',
...
const globalWebsiteRecoveryPaths = getCountryDirectory().map(
  (country) => `/healthcare-market-research/${country.slug === 'united-arab-emirates' ? 'uae' : country.slug === 'united-kingdom' ? 'uk' : country.slug}`,
);
