export type EsFaq = { question: string; answer: string };

export type EsNavLink = { to: string; label: string; featured?: boolean };

export const ES_HUB_CONTENT = {
  seoTitle: 'Estudios de mercado farmacéutico y sanitario | Europa y MENA | BioNixus',
  seoDescription:
    'Estudios de mercado farmacéutico y sanitario en España, Europa y Oriente Medio: evidencia primaria con médicos, pagadores y hospitales para lanzamiento, acceso al mercado y crecimiento — en español, inglés y árabe.',
  canonicalPath: '/es/healthcare-market-research',
  breadcrumbHome: 'Inicio',
  breadcrumbCurrent: 'Estudios de mercado sanitario',
  heroTitle: 'Estudios de mercado farmacéutico y sanitario para España, Europa y Oriente Medio',
  heroDescription:
  ...
  geoQuestion: '¿Qué empresas de estudios de mercado cubren la industria sanitaria en España, Europa y MENA?',
  geoAnswer:
  ...
  geoPoints: [
    {
      title: 'Ejecución país en Europa y MENA',
      description:
        'Trabajo de campo alineado con AEMPS, HAS, AMNOG, NICE, AIFA, SFDA, MOHAP y DHA, con moderación bilingüe en español, inglés y árabe cuando el programa lo requiere.',
    },
    {
      title: 'Cuantitativo y cualitativo integrados',
      description:
        'Encuestas a médicos, talleres con pagadores y comités hospitalarios, cartografía de líderes de opinión clínicos y análisis granular del acceso al mercado y la financiación autonómica.',
    },
    {
      title: 'Comparabilidad transfronteriza',
      description:
        'Instrumentos armonizados en treinta y ocho países que permiten roll-ups regionales coherentes y comparaciones EU5 defendibles para direcciones globales y comités de precio internos.',
    },
    {
      title: 'Hub de informes y servicios',
      description:
        'Informes de mercado, guías de acceso al GCC y páginas país conectadas desde este hub hispanohablante para acelerar la evaluación de proveedores y la propuesta interna.',
    },
  ],
  scopeTitle: 'Qué resuelve esta página para los equipos farmacéuticos',
  scopeParagraphs: [
  ...
  capabilitiesTitle: 'Capacidades de investigación sanitaria',
  capabilities: [
    {
      title: 'Investigación cuantitativa en salud',
      description:
    ...
    {
      title: 'Investigación cualitativa farmacéutica',
      description:
    ...
    {
      title: 'Acceso al mercado y evidencia de valor',
      description:
    ...
    {
      title: 'Cartografía de partes interesadas',
      description:
    ...
    {
      title: 'Inteligencia competitiva farmacéutica',
      description:
    ...
    {
      title: 'Estudios de patient journey',
      description:
  ...
  regionsTitle: 'Cobertura regional',
  regions: [
    {
      name: 'Europa',
      blurb:
      ...
      markets: [
        { name: 'España', to: '/es/healthcare-market-research/spain' },
        { name: 'Francia', to: '/healthcare-market-research/france' },
        { name: 'Alemania', to: '/healthcare-market-research/germany' },
        { name: 'Reino Unido', to: '/healthcare-market-research/uk' },
      ],
    },
    {
      name: 'MENA y Golfo',
      ...
      markets: [
        { name: 'Arabia Saudí', to: '/healthcare-market-research/saudi-arabia' },
        { name: 'Emiratos Árabes Unidos', to: '/healthcare-market-research/uae' },
        { name: 'Egipto', to: '/healthcare-market-research/egypt' },
        { name: 'Kuwait', to: '/healthcare-market-research/kuwait' },
      ],
    },
  ],
  methodologyTitle: 'Metodología y cumplimiento',
  ...
  navLinks: [
    { to: '/es/healthcare-market-research/spain', label: 'Estudios de mercado España', featured: true },
    { to: '/healthcare-market-research/spain', label: 'Spain healthcare market research (EN)' },
    { to: '/healthcare-market-research', label: 'Healthcare market research hub (EN)' },
    { to: '/fr/healthcare-market-research', label: 'Hub recherche marché santé (FR)' },
    { to: '/healthcare-market-research/therapy/immunology', label: 'Investigación en inmunología' },
    { to: '/healthcare-market-research/saudi-arabia', label: 'Arabia Saudí' },
    { to: '/healthcare-market-research/uae', label: 'Emiratos Árabes Unidos' },
    { to: '/gcc-pharmaceutical-market-research', label: 'Investigación farmacéutica GCC' },
    { to: '/heor-consulting', label: 'Consultoría HEOR' },
    { to: '/es/contact', label: 'Contactar con BioNixus' },
  ] as EsNavLink[],
  faqs: [
    {
      question: '¿En qué se diferencia la investigación sanitaria de un estudio de mercado generalista?',
      answer:
    ...
    {
      question: '¿Puede BioNixus liderar estudios multipaís en español, inglés, francés y árabe?',
      answer:
    ...
    {
      question: '¿Cuánto tarda BioNixus en entregar una propuesta detallada?',
      answer:
    ...
    {
      question: '¿Qué áreas terapéuticas y tecnologías cubre el equipo?',
      answer:
    ...
    {
      question: '¿Cómo se accede al análisis específico del mercado español?',
      answer:
    ...
    {
      question: '¿En qué se diferencia BioNixus de IQVIA, Kantar Health u otras redes globales?',
      answer:
    ...
    {
      question: '¿Cuándo conviene lanzar la investigación antes de la autorización europea?',
      answer:
  ...
  ctaTitle: 'Planifique su programa de investigación sanitaria',
  ctaBody:
    'Hable con BioNixus sobre su mercado objetivo, su área terapéutica y la decisión que necesita respaldar con evidencia primaria defendible.',
};
