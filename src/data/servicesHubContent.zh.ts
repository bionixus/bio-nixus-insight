...
export const ZH_SERVICE_FAQ = [
  {
    ...
    answer:
      '我们以中国大陆为重点，并延伸至日本、韩国、新加坡、马来西亚等亚太市场，同时可衔接美国、欧洲与中东项目。BioNixus 在四十八个国家执行调研，覆盖十六个行业垂直领域，每年执行一百二十+个全球项目（2025 年 127 个）。同一套方法论同样适用于 B2B 与 B2C 品类，具体范围请见行业枢纽。',
  },
  {
  ...
  },
  {
    ...
    answer:
      '我们在中国大陆及亚太主要市场执行实地调研，并可扩展至全球四十八个国家；在美国、英国、埃及、沙特阿拉伯、阿联酋、科威特与巴西设有办公室与实地网络。',
  },
  {
    question: '多久可以拿到方案？',
    answer:
