...
const SPECS: SpecRow[] = [
  ...
  row('saudi-arabia-biosimilars-market-report', 'saudi-arabia', 'Saudi Arabia', 'GCC', 'biosimilars', 'NUPCO therapeutic-area framework agreements replacing fixed-volume tenders, SFDA 38+ approved biosimilars with DS-G-113-V1.1 budget-impact requirements, Vision 2030 ICV scoring on local-manufactured biosimilars.', '[Saudi briefing](/saudi-arabia-healthcare-market-report) • [Biosimilar launch Saudi analogue](/biosimilar-market-entry-saudi-arabia).'),
  row('uae-biosimilars-market-report', 'uae', 'United Arab Emirates', 'GCC', 'biosimilars', 'DOH August 2024 biosimilar guideline directing treatment-naive starts on eight molecules, SEHA inpatient biosimilar mandate, EDE Federal Decree-Law 38/2024 registration transition, brand-name prescribing with no pharmacy auto-substitution, insurer step therapy on adalimumab and trastuzumab.', '[UAE healthcare report](/uae-healthcare-market-report) • [GCC biosimilars outlook](/market-reports/gcc-biosimilars-market-report) • [Biosimilar Saudi comparator](/biosimilar-market-entry-saudi-arabia).'),
