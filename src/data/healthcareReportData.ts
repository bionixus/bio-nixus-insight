...
const SPECS: SpecRow[] = [
  ...
  row('bahrain-neurology-cns-market-report', 'bahrain', 'Bahrain', 'GCC', 'neurology-cns', STAT_NR_BH, 'Salmaniya centralised neurology queues, NHRA rapid review on DMT safety registries, causeway commuter referral attribution noise into MS escalation governance.', '[Bahrain healthcare report](/bahrain-healthcare-market-report) • [GCC neurology outlook](/market-reports/gcc-neurology-cns-market-report).'),
  row('oman-neurology-cns-market-report', 'oman', 'Oman', 'GCC', 'neurology-cns', STAT_NR_OM, 'Royal Hospital Muscat electrophysiology throughput, interior governorate referral latency stretching first‑seizure workup intervals, mountainous tele‑neurology adherence gaps unless Arabic UX localized.', '[Oman healthcare report](/oman-healthcare-market-report) • [GCC neurology comparator](/market-reports/gcc-neurology-cns-market-report).'),
  ...
  row('bahrain-biosimilars-market-report', 'bahrain', 'Bahrain', 'GCC', 'biosimilars', STAT_BS_BH, 'compact NHRA interchangeability dossiers versus Salmaniya infusion footprint constraints, causeway leakage distorting audited substitution counts.', '[Bahrain healthcare report](/bahrain-healthcare-market-report) • [GCC biosimilars comparator](/market-reports/gcc-biosimilars-market-report).'),
  ...
  row('qatar-digital-health-market-report', 'qatar', 'Qatar', 'GCC', 'digital-health', STAT_DH_QA, 'Sidra genomics cloud adjacency, Hamad tumour board virtual synchronicity blocked by zero‑trust imaging repositories, FIFA sports medicine digital therapeutics pilots.', '[Qatar healthcare report](/qatar-healthcare-market-report) • [GCC digital health comparator](/market-reports/gcc-digital-health-market-report).'),
  row('bahrain-digital-health-market-report', 'bahrain', 'Bahrain', 'GCC', 'digital-health', STAT_DH_BH, 'NHRA SaMD fast‑track juxtaposed Salmaniya legacy EMR integration debt, causeway commuter telehealth attribution noise.', '[Bahrain healthcare report](/bahrain-healthcare-market-report) • [GCC digital health outlook](/market-reports/gcc-digital-health-market-report).'),
  row('oman-digital-health-market-report', 'oman', 'Oman', 'GCC', 'digital-health', STAT_DH_OM, 'interior governorate connectivity gaps breaking Arabic dialect NLP accuracy in chatbot adherence programmes, Royal Hospital Muscat cloud imaging pilot scale‑up.', '[Oman healthcare report](/oman-healthcare-market-report) • [GCC digital health briefing](/market-reports/gcc-digital-health-market-report).'),
  ...
  row('bahrain-vaccines-market-report', 'bahrain', 'Bahrain', 'GCC', 'vaccines', STAT_VC_BH, 'NHRA rapid conjugate reviews, Salmaniya school mandate cohesion, causeway commuter vaccination attribution challenges.', '[Bahrain healthcare report](/bahrain-healthcare-market-report) • [GCC vaccines outlook](/market-reports/gcc-vaccines-market-report).'),
  ...
  row('uae-dermatology-market-report', 'uae', 'United Arab Emirates', 'GCC', 'dermatology', STAT_DR_UAE, 'Dubai tourism chlorine pool eczema clusters, dupilumab adolescent atopic programmes in international schools, DOH versus DHA biologic PA divergence.', '[UAE healthcare report](/uae-healthcare-market-report) • [GCC dermatology briefing](/market-reports/gcc-dermatology-market-report).'),
