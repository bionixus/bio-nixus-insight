...
export const BAHRAIN_BIOSIMILARS_COPY: OverrideCopy = {
  ...
  fieldIntelligenceParagraph:
    'BioNixus field programmes treat Bahrain biosimilars as a compact-account market where NHRA interchangeability decisions and Salmaniya infusion capacity set the pace. We pair NHRA dossier tracking with prescriber confidence studies and causeway-leakage audits—because cross-border care can understate or overstate Bahrain switching depending on where infusions are administered. For originators, we map defence levers in private hospitals that retain premium insured patients after public formulary refresh. Salmaniya infusion chair throughput and pharmacist workflow frictions often determine whether interchangeability dossiers convert into sustained volume within a single tender cycle.',
  commercialOutlookParagraph:
    'The outlook to 2030 is moderate-growth in absolute terms but high percentage growth from a small base. Biosimilar developers gain access through NHRA registration and Salmaniya formulary placement; originators face incremental erosion as interchangeability dossiers clear. BioNixus uses a ~16% planning band; validate causeway leakage before locking Bahrain share assumptions. Teams should model Eastern Province Saudi hospital pull separately from audited Bahrain volume when forecasting anti-TNF and oncology monoclonal biosimilar share. Private hospital defence programmes remain material when NHRA interchangeability accelerates public formulary refresh.',
  methodologyParagraph:
    'Methodology combines BioNixus market analysis for sizing and CAGR bands—calibrated against Bahrain immunology and oncology therapy spend shares—with desk review of NHRA interchangeability guidance and Salmaniya formulary practice. Primary modules include prescriber confidence surveys where data is available. Outputs are built for market access and commercial leadership and do not constitute regulatory or clinical advice. Causeway leakage audits are recommended when forecasting Bahrain substitution telemetry against Eastern Province Saudi hospital volume.',
  sourceNotes: [
  ...
  faqs: [
    ...
    {
      question: 'Which molecules lead Bahrain biosimilar tenders in 2026?',
      answer:
        'Anti-TNF immunology biosimilars and oncology monoclonal biosimilars (trastuzumab, bevacizumab) account for most hospital-administered biosimilar value at Salmaniya and King Hamad University Hospital. Filgrastim and supportive-care biosimilars add steady volume in oncology maintenance settings. BioNixus maps molecule-level tender timing and interchangeability dossier status rather than applying a single Gulf switch curve.',
    },
  ],
};
