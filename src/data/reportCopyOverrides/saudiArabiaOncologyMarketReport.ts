...
export const SAUDI_ARABIA_ONCOLOGY_COPY: OverrideCopy = {
  ...
  summaryPara2:
    'Use this report with the [Saudi Arabia healthcare market report](/saudi-arabia-healthcare-market-report) for macro context, the [Saudi Arabia cancer diagnostics market report](/market-reports/saudi-arabia-cancer-diagnostics-market-report) when companion diagnostics, NGS, or imaging capacity gate therapy starts, the [SFDA market access strategy for Saudi Arabia](/sfda-market-access-strategy-saudi-arabia) when registration and NUPCO listing sit on your critical path, the [Saudi Arabia biosimilars market report](/market-reports/saudi-arabia-biosimilars-market-report) for tender-led substitution on mature antibodies, the [Saudi Arabia vaccine market report](/market-reports/saudi-arabia-vaccines-market-report) for BioNixus’s adjacent Saudi pharma-insights cluster, the [GCC oncology market report](/market-reports/gcc-oncology-market-report) for Gulf-wide benchmarking, [oncology therapy research](/healthcare-market-research/therapy/oncology) for programme design, and the [healthcare market research hub](/healthcare-market-research) to scope bilingual fieldwork.',
  marketAccessNotes:
