...
> = {
  ...
  spain: {
    ...
    marketParagraphs: [
      ...
      'Spain\'s regional health systems (SERMAS Madrid, CatSalut Catalonia, Andalusian SAS) run independent procurement — a Madrid formulary win does not transfer to Valencia or Galicia. BioNixus Spain modules tag autonomous community and hospital-group affiliation so manufacturers avoid overstating national reach from a single-cluster study.',
    ],
  },
  switzerland: {
    slug: 'switzerland',
    ...
    marketParagraphs: [
      ...
      'Swiss hospital groups (Hirslanden, Swiss Medical Network) and cantonal public systems evaluate devices on different economic criteria — premium innovator adoption in Zurich and Geneva does not predict uptake in smaller cantons. BioNixus segments research by linguistic region and payer type so launch forecasts reflect real adoption corridors.',
    ],
  },
  denmark: {
    slug: 'denmark',
    ...
    marketParagraphs: [
      ...
      'Denmark\'s five regional health authorities (Region Hovedstaden through Region Syddanmark) coordinate through SKI framework agreements for selected categories — understanding which devices fall under national tender versus hospital discretion prevents mis-timed launch investment. BioNixus maps regional procurement rhythm alongside KOL adoption at Rigshospitalet and Aarhus University Hospital.',
    ],
  },
  'new-zealand': {
    slug: 'new-zealand',
  ...
  malaysia: {
    ...
    marketParagraphs: [
      ...
      'Malaysia\'s dual MOH public hospitals and IHH/Pantai private chains follow different capital and consumables procurement paths — research that blends both without tagging payer type systematically overstates private adoption. BioNixus Malaysia programmes separate MOH tender behaviour from private hospital group preferences and map ASEAN re-export intent for manufacturers using Malaysia as a regional hub.',
    ],
  },
  brazil: {
    slug: 'brazil',
    ...
    marketParagraphs: [
      ...
      'Brazil\'s ANVISA RDC 665/2022 and INMETRO certification requirements for certain device classes add documentation layers that EU MDR-experienced teams underestimate. BioNixus Brazil programmes map predicate pathways, local representation obligations, and SUS versus private hospital procurement calendars before launch sequencing commits.',
    ],
  },
};
