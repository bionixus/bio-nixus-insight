...
function buildMethodology(label: string) {
  return {
    ...
    paragraphs: [
      ...
      `Sponsors comparing BioNixus to IQVIA, Kantar Health, or syndicated device trackers should expect decision-led primary research: verified hospital and clinician respondents, procurement-aware modules, and audit-ready methodology appendices — not repackaged secondary revenue tables. When your brief spans ${label} and Gulf tenders, we link local adoption intelligence to SFDA, MOHAP, and NUPCO context in optional extension modules.`,
    ],
  };
}
