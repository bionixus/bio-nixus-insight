...
export function bioNixusServicesParagraph(marketSlug: string, marketName: string, therapyName: string): string {
  ...
  const local: Record<string, string> = {
    turkey: `BioNixus supports ${therapyLower} teams in ${marketName} with TİTCK dossier tracking, SGK SUT listing and hospital procurement intelligence, physician and payer qualitative research, and consumption analogue panels at tertiary centres such as ${institutionAnchorsForMarket(marketSlug)}. Deliverables follow EphMRA and BHBIA standards with GDPR-aligned governance for multinational sponsors. Forecasts are cross-checked against Turkish public and private channel splits before leadership teams commit to launch or expansion scenarios.`,
    uk: `BioNixus supports ${therapyLower} teams in ${marketName} with MHRA and NICE/ICB-aware access research, NHS and private hospital consumption analogues, specialist qualitative depth, and launch sequencing evidence at networks including ${institutionAnchorsForMarket(marketSlug)}. Methodology aligns with EphMRA, BHBIA, and GDPR requirements. Teams receive decision-ready outputs that separate HTA implementation timing from desk assumptions drawn from unrelated markets.`,
    germany: `BioNixus supports ${therapyLower} teams in ${marketName} with G-BA and AMNOG-aware evidence planning, statutory sickness fund formulary intelligence, and hospital analogue panels at centres such as ${institutionAnchorsForMarket(marketSlug)}. Programmes run under EphMRA and BHBIA governance with GDPR-aligned multinational fieldwork. Adoption and access narratives are validated against German payer rules rather than Gulf tender mechanics.`,
    usa: `BioNixus supports ${therapyLower} teams in ${marketName} with payer and IDN formulary intelligence, specialty pharmacy dynamics research, and hospital consumption analogues at institutions such as ${institutionAnchorsForMarket(marketSlug)}. Work aligns to ICC/ESOMAR and US privacy norms for multinational programmes. Commercial planning separates Medicare, Medicaid, and commercial channel assumptions before portfolio investment decisions.`,
    canada: `BioNixus supports ${therapyLower} teams in ${marketName} with CADTH and pCPA-aware access research, provincial formulary tracking, and specialist adoption studies at networks such as ${institutionAnchorsForMarket(marketSlug)}. Governance follows BHBIA-aligned standards with GDPR where applicable for EU-headquartered sponsors. Launch sequencing reflects provincial implementation lag after national recommendations.`,
    australia: `BioNixus supports ${therapyLower} teams in ${marketName} with TGA, PBAC, and MBS-aware access research, hospital consumption analogues, and specialist adoption tracking at centres such as ${institutionAnchorsForMarket(marketSlug)}. Outputs follow EphMRA and BHBIA methodological standards. Teams stress-test uptake against live PBAC and state hospital formulary decisions.`,
    japan: `BioNixus supports ${therapyLower} teams in ${marketName} with PMDA and Chuikyo reimbursement intelligence, hospital consumption analogues, and specialist adoption research at institutions such as ${institutionAnchorsForMarket(marketSlug)}. Field governance aligns with multinational privacy and quality requirements. Pricing and listing assumptions are refreshed when Chuikyo revisions affect net access.`,
    china: `BioNixus supports ${therapyLower} teams in ${marketName} with NRDL and VBP-aware access intelligence, hospital adoption research, and physician qualitative depth for multinational portfolio teams. Analysis references tier-1 provincial centres rather than unrelated regional procurement models. NRDL cycle timing and provincial implementation are tracked for launch planning.`,
    india: `BioNixus supports ${therapyLower} teams in ${marketName} with CDSCO registration context, tender and private hospital intelligence, and physician adoption research at leading centres such as ${institutionAnchorsForMarket(marketSlug)}. Methodology follows EphMRA and BHBIA governance. Public tender and private channel splits are modelled separately in forecasts.`,
    brazil: `BioNixus supports ${therapyLower} teams in ${marketName} with ANVISA and SUS/ANS reimbursement intelligence, hospital adoption analogues, and specialist qualitative programmes at institutions such as ${institutionAnchorsForMarket(marketSlug)}. Deliverables support launch and access teams with decision-ready evidence under international quality standards.`,
    'south-korea': `BioNixus supports ${therapyLower} teams in ${marketName} with MFDS and NHIS/HIRA listing intelligence, tertiary hospital adoption research, and payer-aware qualitative depth at centres such as ${institutionAnchorsForMarket(marketSlug)}. Forecasts are validated against national reimbursement rules and hospital protocol activation.`,
    singapore: `BioNixus supports ${therapyLower} teams in ${marketName} with HSA and ACE HTA-aware access research, public-private hospital intelligence, and consumption analogue panels at centres such as ${institutionAnchorsForMarket(marketSlug)}. Programmes follow EphMRA and BHBIA governance with GDPR-aligned multinational coordination.`,
  };
  return (
    local[marketSlug] ??
    `BioNixus supports ${therapyLower} teams in ${marketName} with regulator-aware access research, hospital consumption analogues, payer and specialist qualitative depth, and launch evidence at ${institutionAnchorsForMarket(marketSlug)}. Methodology follows EphMRA and BHBIA governance with GDPR-aligned fieldwork where required.`
  );
}
