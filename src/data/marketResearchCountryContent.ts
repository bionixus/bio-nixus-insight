...
const en: Record<string, MarketResearchCountryContent> = {
  uae: {
    ...
    relatedLinks: [
      ...
      { to: '/blog/uae-healthcare-market-trends-2026', label: 'UAE healthcare market trends 2026' },
...
const ar: Record<string, MarketResearchCountryContent> = {
  'ar-uae': {
    ...
    relatedLinks: [
      ...
      { to: '/blog/uae-healthcare-market-trends-2026', label: 'اتجاهات سوق الرعاية الصحية في الإمارات 2026' },
      { to: '/blog/uae-healthcare-market-trends-2025', label: 'اتجاهات سوق الرعاية الصحية في الإمارات 2025' },
