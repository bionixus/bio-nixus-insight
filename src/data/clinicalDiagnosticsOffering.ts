...
export const relatedLinks = [
  ...
  { to: '/saudi-arabia-medical-devices-market-report', label: 'MedTech market research — Saudi Arabia' },
  { to: '/uae-medical-devices-market-report', label: 'MedTech market research — UAE' },
  { to: '/egypt-medical-devices-market-report', label: 'MedTech market research — Egypt' },
