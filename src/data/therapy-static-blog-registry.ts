...
import {
  ...
  NF1_KOSELUGO_DRUG_BODY_HTML,
  NF1_KOSELUGO_DRUG_DISPLAY_TITLE,
  NF1_KOSELUGO_DRUG_EXECUTIVE_SUMMARY_HTML,
  NF1_KOSELUGO_DRUG_META_DESCRIPTION,
  NF1_KOSELUGO_DRUG_META_TITLE,
  NF1_KOSELUGO_DRUG_OG_DESCRIPTION,
  NF1_KOSELUGO_DRUG_SCHEMA_FAQ,
  NF1_KOSELUGO_DRUG_SCHEMA_MENTIONS,
  NF1_KOSELUGO_DRUG_SCHEMA_ITEM_LIST,
  NF1_KOSELUGO_DRUG_TABLE_OF_CONTENTS,
...
const NF1_KOSELUGO_DRUG_BUNDLE: TherapyStaticBlogBundle = {
  ...
  tableOfContents: [...NF1_KOSELUGO_DRUG_TABLE_OF_CONTENTS],
...
const BY_SLUG: Record<string, TherapyStaticBlogBundle> = {
  ...
  [NF1_KOSELUGO_DRUG_BLOG_SLUG]: NF1_KOSELUGO_DRUG_BUNDLE,
