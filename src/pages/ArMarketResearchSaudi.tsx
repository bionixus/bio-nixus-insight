...
export default function ArMarketResearchSaudi() {
  return (
    <MarketResearchCountryLanding
      ...
      description="صفحة أبحاث السوق في السعودية للقطاع الصحي والدوائي تشمل طرق الوصول لمزيج الخدمات الكمّية والنوعية، وممرات وزارة الصحة، وروابط لأبحاث السوق بالمملكة وكبار شركات الدواء."
