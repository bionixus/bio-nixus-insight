  ...
  <div className="min-h-screen bg-background">
    ...
    />
      ...
      <div className="section-padding pt-24 pb-4"><div className="container-wide"><BreadcrumbNav items={breadcrumbItems} /></div></div>
              <ReportPremiumHero
          title="China Healthcare Market Report 2026: NMPA Approval, NRDL Reimbursement, and VBP Commercial Intelligence"
          description="BioNixus provides China and GCC comparative market intelligence for global pharmaceutical and medical device companies — helping multi-market commercial teams prioritise between China's large but price-compressed market and the GCC's premium-priced, fast-growing healthcare opportunity."
          config={REPORT_CONVERSION}
          marketSlug="china"
          countryName="China"
          stats={[
            { value: '~$1.3T', label: 'China healthcare market 2026' },
            { value: '~$175B', label: 'Pharmaceutical market 2026' },
            { value: '~$80B', label: 'Medical devices market 2026' },
          ]}
        />
