...
const PAGE_AUTHOR = getEditorialAuthor({
  path: '/insights/top-market-research-companies-australia-2026',
  pageType: 'comparison',
});
...
export default function TopMarketResearchCompaniesAustralia2026() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Top Market Research Companies in Australia (2026)', item: PAGE_CANONICAL },
    ],
  };
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Top Market Research Companies in Australia 2026 | BioNixus</title>
        <meta
          name="description"
