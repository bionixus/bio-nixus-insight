        ...
        <section className="section-padding" id="regulatory">
          ...
          <div className="container-wide max-w-4xl mx-auto">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              <Link to="/pharmaceutical-companies-uae" className="text-primary hover:underline font-medium">pharmaceutical companies in UAE</Link>{' '}and{' '}
              <Link to="/healthcare-market-research/uae" className="text-primary hover:underline font-medium">healthcare market research in UAE</Link>.
            </p>
          </div>
        </section>
