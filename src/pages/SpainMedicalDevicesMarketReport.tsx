    ...
    <main>
      ...
      <section className="section-padding pb-10">
        <div className="container-wide max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-5xl font-display font-bold text-foreground mb-6">Spain Medical Devices Market Report 2026: AEMPS Regulation, SNS Reimbursement, and Regional Procurement Intelligence</h1>
          <p className="text-muted-foreground leading-relaxed">BioNixus delivers Spain and EU medical device market intelligence — AEMPS regulatory tracking, regional procurement strategies, hospital-level device consumption research, and GCC/MENA market entry intelligence for Spanish and European medtech manufacturers.</p>
        </div>
      </section>
      ...
      <FAQSection sectionId={FAQ_SECTION_ID} title="Spain medical devices market 2026 — AEMPS, RAMD, SNS reimbursement, and regional procurement FAQ" items={REPORT_FAQ_ITEMS} className="bg-muted/30" />
      <section className="section-padding bg-primary/5" id="contact-cta">
        <div className="container-wide max-w-3xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-display font-semibold text-foreground mb-4">BioNixus: GCC & MENA Intelligence for Spanish and European Medtech</h2>
          <p className="text-muted-foreground leading-relaxed mb-8 max-w-2xl mx-auto">Spanish and European medical device companies expanding into GCC and MENA markets. BioNixus delivers regulatory intelligence, hospital procurement data, and distributor mapping across Saudi Arabia, UAE, and the wider region.</p>
