      ...
      <ReportContentWithAside config={REPORT_CONVERSION}>
        ...
        <div className="container-wide max-w-4xl mx-auto">
          ...
          <p className="text-muted-foreground leading-relaxed">See also: <Link to="/spain-healthcare-market-report" className="text-primary hover:underline font-medium">Spain Healthcare Market Report</Link> and <Link to="/gcc-medical-devices-market-report" className="text-primary hover:underline font-medium">GCC Medical Devices Market Report</Link>.</p>
              ...
              <MarketIntelligenceSections marketSlug="spain" countryName="Spain" variant="medical-devices" />
        ...
        <section className="section-padding" id="related-intelligence">
          <div className="container-wide max-w-4xl mx-auto">
            ...
            <p className="text-muted-foreground leading-relaxed">
              BioNixus runs medical device and MedTech market research across Europe. Compare the Spain device market with our{' '}
              <Link to="/italy-medical-devices-market-report" className="text-primary hover:underline font-medium">Italy medical devices market report</Link>{' '}and{' '}
              ...
              <Link to="/spain-healthcare-market-report" className="text-primary hover:underline font-medium">Spain healthcare market report</Link>, or widen the lens with the{' '}
