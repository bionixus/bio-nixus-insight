      ...
      <main>
        ...
        <section className="section-padding py-16" id="market-overview"><div className="container-wide max-w-5xl mx-auto">
          ...
          <div className="prose-body text-muted-foreground leading-relaxed space-y-4 max-w-4xl">
            ...
            <p>
              Commercial teams should treat KIMADIA tender calendars, KRG parallel procurement, and private-hospital cash channels as three sample frames—not one national average. BioNixus maps which manufacturers repeat on KIMADIA awards, how Baghdad and Erbil distributors differ on cold-chain and registration, and where NGO tenders create episodic volume spikes that distort year-on-year share if ignored.
            </p>
          </div>
        </div></section>
