...
const faqItems = [
  ...
  { q: 'Which therapeutic areas drive pharmaceutical demand in Iraq?', a: 'Diabetes, cardiovascular disease, oncology, and infectious disease represent the highest-volume therapeutic corridors in Iraq\'s USD 2.8 billion market. Chronic disease burden across 44.5 million population — one of the youngest demographics in the Arab world — sustains long-term demand for metabolic, cardiovascular, and specialty therapies alongside essential medicines supplied through KIMADIA tenders.' },
  { q: 'How do NGO and international health partnerships affect Iraq market access?', a: 'NGO and international health partnerships play a significant role in supply, access, and capacity building — particularly for specialty medicines, vaccines, and hospital infrastructure. Manufacturers should map both KIMADIA government procurement and NGO/international procurement channels when sizing addressable demand and designing stakeholder research across federal Iraq and the Kurdistan Region.' },
  { q: 'What is the outlook for local pharmaceutical manufacturing in Iraq?', a: 'Local manufacturing is limited today (~80% import dependency) but post-conflict healthcare reconstruction ($5B+ invested) is driving investment in domestic capacity. SDI (Samarra), Iraqi-Egyptian Company, Pioneer Industries, and Dar Al Dawa (Erbil) anchor current production. Research programmes should track both tender-driven government demand and private-channel growth as insurance coverage expands.' },
];
