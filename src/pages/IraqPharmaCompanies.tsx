...
const faqItems = [
  ...
  { q: 'Which therapy areas drive Iraqi pharmaceutical demand?', a: 'Cardiovascular, diabetes, infectious disease, and essential medicines volumes dominate public procurement through KIMADIA, while private channels carry more innovative and specialty share. Research should separate federal tender dynamics from KRG and private pharmacy pathways rather than reporting one national average.' },
  { q: 'How does BioNixus research Iraq for market entry teams?', a: 'BioNixus maps KIMADIA tender behaviour, KRG procurement differences, distributor landscape, and prescriber/payer stakeholders with primary interviews — producing decision-ready intelligence for dual-market access planning rather than syndicated import statistics alone.' },
  { q: 'Which multinational companies are active in Iraq?', a: 'Major MNC offices include Pfizer, Novartis, Roche, Sanofi, AstraZeneca, GSK, and Novo Nordisk — typically supplying innovator and specialty medicines through KIMADIA tenders and private distributors. Regional players such as Hikma and Julphar also maintain strong Iraq presence alongside local manufacturers SDI and Pioneer Industries.' },
];
