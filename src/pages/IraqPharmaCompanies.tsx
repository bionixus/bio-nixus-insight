...
const faqItems = [
  ...
  { q: 'Which therapeutic areas drive Iraqi pharma demand?', a: 'Chronic metabolic and cardiovascular disease, respiratory conditions, oncology, and infectious disease categories account for a large share of public and private volume. Specialty therapies increasingly enter through KIMADIA tenders and private distributors as reconstruction expands hospital capacity in Baghdad, Basra, and Erbil.' },
  { q: 'How do KIMADIA tenders work for multinational manufacturers?', a: 'Foreign companies typically register via MOH/KIMADIA, appoint a local agent, and compete on price and supply reliability in periodic tenders that supply MOH hospitals. Winning a KIMADIA listing does not automatically secure KRG formulary placement—teams must run parallel KRG registration and distributor strategies.' },
  { q: 'What is BioNixus’s role in Iraq market research?', a: 'BioNixus delivers primary research on prescriber behaviour, tender dynamics, distributor landscape, and dual federal–KRG access planning—linking findings to the healthcare market research hub and MENA pharmaceutical market data for portfolio teams evaluating Iraq alongside GCC expansion.' },
  { q: 'How does Iraq compare to GCC markets for pharma access?', a: 'Iraq’s KIMADIA-dominated public channel and lower per-capita spend contrast with GCC external reference pricing and insurance-led private markets. Companies often sequence Iraq after GCC registration to leverage regional manufacturing credentials and distributor relationships from UAE, Jordan, or Saudi partners.' },
];
...
const IraqPharmaCompanies = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      />
      <Navbar />
      <ReportReadingProgress progressId="pharma-guide-rp-iraq" />
      <main>
        ...
        <section className="section-padding py-16 bg-muted/30" id="growth-drivers"><div className="container-wide max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">{[
            ...
            { title: 'Import Dependency & Supply Chain', desc: 'With roughly 80% import reliance, manufacturers and distributors compete on tender reliability, cold-chain logistics, and MOH/KIMADIA compliance. Supply disruptions quickly affect public hospitals; private pharmacies depend on major wholesalers such as Ibn Hayyan, Dijla, and Al Masar for consistent stock.' },
        ...
        <div className="fixed bottom-0 left-0 right-0 z-40 bg-background border-t border-border shadow-lg p-4">
          <div className="container-wide max-w-3xl mx-auto">
            <ConversionCTA
              ...
              reportName="GCC Pharma & MedTech Market Databook 2026"
              pdfPath="/downloads/gcc-pharma-medtech-databook-2026-sample.pdf"
              ctaId="pharma_companies_iraq_scroll70"
