...
const faqItems = [
  ...
  { q: 'How should distributors be evaluated for Iraq government tenders?', a: 'KIMADIA awards favour distributors with warehousing capacity, cold-chain compliance, and proven MOH delivery track records. Research with procurement stakeholders clarifies scoring weight on price versus supply reliability — critical when tender calendars compress decision windows.' },
  { q: 'Can market research support Iraq launch sequencing across federal and KRG channels?', a: 'Yes. Parallel modules map formulary and tender differences between Baghdad and Erbil, identifying where a single dossier strategy suffices versus where separate pricing, packaging, or partner structures are required before field investment scales.' },
  { q: 'Which therapeutic areas drive Iraq pharmaceutical import growth?', a: 'Oncology, diabetes, cardiovascular, and anti-infective categories lead import demand alongside chronic disease expansion from post-conflict healthcare reconstruction. Segment-specific research prevents blended hospital averages from mispricing launch sequencing.' },
];
