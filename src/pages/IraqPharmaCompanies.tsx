...
const faqItems = [
  ...
  { q: 'How does BioNixus support pharmaceutical companies in Iraq?', a: 'BioNixus provides KIMADIA tender intelligence, federal versus KRG pathway mapping, distributor qualification research, and competitive landscaping for teams planning Iraq entry or portfolio defence. Programmes link to wider MENA pharmaceutical company guides when regional sequencing matters.' },
  { q: 'Which therapy areas drive Iraq pharmaceutical demand?', a: 'Chronic disease burden, post-conflict reconstruction of hospital networks, and infectious-disease programmes shape demand across cardiovascular, diabetes, oncology, and essential medicines. Private pharmacies and NGO channels supplement KIMADIA-led public procurement — research should model both when forecasting uptake.' },
  { q: 'How do international NGOs affect Iraq drug distribution?', a: 'NGO and humanitarian supply chains operate alongside KIMADIA and private distributors, especially for essential medicines and conflict-affected regions. Market entry plans should map federal, KRG, and NGO channels separately because registration, pricing, and logistics differ materially across pathways.' },
];
