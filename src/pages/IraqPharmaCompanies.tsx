...
const faqItems = [
  ...
  { q: 'Which therapy areas drive pharmaceutical demand in Iraq?', a: 'Chronic metabolic and cardiovascular disease, oncology, respiratory conditions, and infectious diseases generate sustained demand across both KIMADIA public tenders and the 30,000+ private pharmacy network. Post-conflict reconstruction has expanded hospital capacity in Baghdad, Basra, and Erbil, increasing demand for hospital-administered biologics, oncology medicines, and critical-care injectables alongside high-volume generic oral therapies.' },
  { q: 'How do KIMADIA tenders work for pharmaceutical suppliers?', a: 'KIMADIA issues periodic central tenders for Ministry of Health facilities, evaluating price, registration status, supply reliability, and local distribution capability. Winning a KIMADIA award secures large-volume public sector contracts but requires competitive tender pricing and reliable cold-chain logistics. Private channel sales through distributors (Ibn Hayyan, Dijla Pharma, Al Masar) operate at different price points with faster formulary decisions — successful Iraq strategies typically combine both channels.' },
];
