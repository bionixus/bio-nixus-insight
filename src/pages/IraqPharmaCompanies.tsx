...
const faqItems = [
  ...
  { q: 'How large is Iraq\'s private pharmacy channel versus KIMADIA tenders?', a: 'Roughly 30,000 private pharmacies serve out-of-pocket and insurance-funded demand alongside KIMADIA\'s federal hospital supply. Innovator brands with limited tender wins often build volume through private distributors (Ibn Hayyan, Dijla Pharma) while negotiating KIMADIA inclusion for public-sector scale. BioNixus maps dual-channel dynamics so launch forecasts separate tender lag from retail pull-through.' },
  { q: 'How do international NGOs and reconstruction funds influence Iraq pharma demand?', a: 'Post-conflict healthcare reconstruction channels significant procurement through MOH, KIMADIA, and NGO partnerships that supplement public hospital supply—especially for vaccines, essential medicines, and chronic disease programmes. Manufacturers should track which categories receive donor-funded tenders versus standard KIMADIA awards. BioNixus fieldwork with pharmacists and procurement officers surfaces where NGO pipelines create parallel access routes not visible in federal tender data alone.' },
];
