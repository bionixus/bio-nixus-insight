...
const faqItems = [
  ...
  { q: 'How does KIMADIA tender pricing affect pharmaceutical margins in Iraq?', a: 'KIMADIA sets government tender prices for federal Iraq public facilities — winning tenders secures volume but compresses margins versus private pharmacy channels. Launch teams should model federal tender economics separately from Kurdistan Region (KRG) procurement and the 30,000+ private pharmacies that serve cash-pay and supplementary demand. BioNixus researches win/loss drivers and post-award uptake after KIMADIA awards.' },
];
