...
const faqItems = [
  ...
  { q: 'How does KIMADIA tender pricing work for pharmaceutical suppliers?', a: 'KIMADIA runs periodic tenders for the federal MOH supply chain. Award criteria combine price, registration status, local manufacturing preference, and supply reliability. Winning a KIMADIA line does not guarantee private-pharmacy pull-through — BioNixus separates public tender dynamics from the 30,000+ private pharmacy channel when sizing opportunity.' },
  { q: 'Which therapy areas have the highest unmet need in Iraq?', a: 'Oncology, diabetes, cardiovascular disease, and respiratory conditions show high chronic burden with import dependency for innovative molecules. Post-conflict reconstruction investment ($5B+ in healthcare infrastructure) is expanding hospital capacity in Baghdad, Basra, and Erbil — creating formulary and tender windows for both generics and branded products.' },
  { q: 'How should companies approach dual federal and KRG registration?', a: 'Federal Iraq registration through MOH/KIMADIA does not automatically cover Kurdistan Region formulary access. KRG maintains separate procurement and pricing. Companies targeting nationwide coverage need parallel regulatory and distributor strategies — often with different local partners in Baghdad versus Erbil corridors.' },
  { q: 'What is the role of NGO and international health partnerships in Iraq?', a: 'WHO, UNICEF, and bilateral health programmes supplement MOH supply for vaccines, essential medicines, and conflict-affected populations. NGO channels can accelerate access for selected products but require separate forecasting from KIMADIA tender volumes. BioNixus maps NGO versus public procurement when teams size total addressable market.' },
];
