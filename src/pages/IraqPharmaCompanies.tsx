  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta property="og:title" content="Pharmaceutical Companies in Iraq — Complete Industry Guide 2026" />
        <meta property="og:description" content="Comprehensive guide: 18+ pharmaceutical companies in Iraq, $2.8B market data, KIMADIA regulatory landscape, KRG market, and outlook." />
