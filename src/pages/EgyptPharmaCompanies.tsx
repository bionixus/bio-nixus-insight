      ...
      <main>
        ...
        <section className="section-padding py-16" id="market-overview"><div className="container-wide max-w-5xl mx-auto">
          ...
          <div className="prose-body text-muted-foreground leading-relaxed space-y-4 max-w-4xl">
            ...
            <p>For a broader regional comparison, see our <Link to="/mena-pharma-market-data" className="text-primary hover:underline">MENA Pharmaceutical Market Data 2026</Link> and <Link to="/gcc-market-access-guide" className="text-primary hover:underline">GCC Pharmaceutical Market Access Guide</Link>. For market research services, see the <Link to="/insights/top-market-research-companies-egypt-2026" className="text-primary hover:underline">best market research companies in Egypt (2026 rankings)</Link> and our <Link to="/strategic-portfolio" className="text-primary hover:underline">strategic portfolio</Link>.</p>
          </div>
        </div></section>
        ...
        <div className="fixed bottom-0 left-0 right-0 z-40 bg-background border-t border-border shadow-lg p-4">
          <div className="container-wide max-w-3xl mx-auto">
            <ConversionCTA
              ...
              ctaId="pharma_companies_egypt_scroll70"
