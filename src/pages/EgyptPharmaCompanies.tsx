    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <section className="section-padding pt-0 pb-12"><div className="container-wide max-w-5xl mx-auto">
          ...
          <p className="text-sm text-muted-foreground">Last updated: June 2026 &middot; Sources: EDA, BioNixus MEA, company filings, industry reports</p>
        ...
        <section className="section-padding py-16" id="market-overview"><div className="container-wide max-w-5xl mx-auto">
          ...
          <div className="prose-body text-muted-foreground leading-relaxed space-y-4 max-w-4xl">
            ...
            <p>For a broader regional comparison, see our <Link to="/mena-pharma-market-data" className="text-primary hover:underline">MENA Pharmaceutical Market Data 2026</Link> and <Link to="/gcc-market-access-guide" className="text-primary hover:underline">GCC Pharmaceutical Market Access Guide</Link>. For market research services, see the <Link to="/blog/top-market-research-companies-egypt-2026" className="text-primary hover:underline">top market research companies in Egypt (2026 guide)</Link> and our <Link to="/strategic-portfolio" className="text-primary hover:underline">strategic portfolio</Link>.</p>
          </div>
        </div></section>
        ...
        <MarketResearchEquityLinks country="egypt" />
