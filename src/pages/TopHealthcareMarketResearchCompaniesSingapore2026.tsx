...
const PAGE_AUTHOR = getEditorialAuthor({
  path: '/insights/top-healthcare-market-research-companies-singapore-2026',
  pageType: 'comparison',
});
...
export default function TopHealthcareMarketResearchCompaniesSingapore2026() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Singapore Healthcare Market Research Companies 2026 | BioNixus</title>
        <meta
          name="description"
      ...
      <OpenGraphMeta
        title="Top Healthcare Market Research Companies in Singapore | BioNixus"
