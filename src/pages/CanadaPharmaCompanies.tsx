      ...
      <main>
        <LegacyDirectoryChrome
          breadcrumbs={[
            ...
            { name: 'Pharmaceutical Companies in Canada', href: '/pharmaceutical-companies-canada' },
          ]}
          h1="Pharmaceutical Companies in Canada"
          lead={
            <>
              Canada combines a strong generics manufacturing base (led by Apotex and peers) with multinational specialty franchises serving provincial public plans and private insurers. Pharmaceutical companies in Canada navigate Health Canada approval and CADTH/pCPA access — start from <Link to="/healthcare-market-research">healthcare market research</Link> for programme scoping. This guide covers major manufacturers, distributors, regulatory context, and strategic opportunities.
            </>
          }
          metaLine="Last updated: August 2026 · Sources: Health Canada, CADTH, company filings, BioNixus research"
          stats={[
            { value: 'OECD', label: 'Major OECD pharma market' },
            { value: '13', label: 'Provincial / territorial plans' },
            { value: 'HC', label: 'Health Canada regulator' },
            { value: 'CADTH', label: 'HTA / listing influence' },
          ]}
          jumpItems={[
          ...
          proposalLabel="Request a Canada proposal"
          citationUrl={citationUrl}
          citeHeadline="Pharmaceutical Companies in Canada: Complete Industry Guide 2026"
        ...
        <section className="section-padding py-10" id="country-directories"><div className="container-wide w-full">
          <CountryDirectoryLinks country="canada" excludePath="/pharmaceutical-companies-canada" compact />
        </div></section>
