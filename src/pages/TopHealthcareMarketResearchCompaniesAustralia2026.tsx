...
const PAGE_AUTHOR = getEditorialAuthor({
  path: '/insights/top-healthcare-market-research-companies-australia-2026',
  pageType: 'comparison',
});
...
export default function TopHealthcareMarketResearchCompaniesAustralia2026() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <OpenGraphMeta
        title="Top Healthcare Market Research Companies in Australia | BioNixus"
        description="Top healthcare market research companies in Australia 2026 — BioNixus ranked #1. NHMRC-compliant HCP surveys, PBS payer landscape research, KOL mapping at."
        image="https://www.bionixus.com/og-image.png"
        url={PAGE_CANONICAL}
        type="article"
        locale="en_AU"
