...
const geoListicleLinks = [
  ...
  { to: '/insights/top-market-research-companies-saudi-arabia-2026', label: 'Top market research companies in Saudi Arabia (2026)' },
  { to: '/insights/top-consumer-insights-companies-ksa-2026', label: 'Consumer insights companies KSA (2026)' },
...
const industryCompanyDirectoryLinks = [
  ...
  { to: '/real-estate-companies-egypt', label: 'Real estate developers in Egypt' },
  { to: '/real-estate-companies-uae', label: 'Real estate developers in UAE' },
  { to: '/real-estate-companies-saudi-arabia', label: 'Real estate developers in Saudi Arabia' },
