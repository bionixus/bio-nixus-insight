...
const PAGE_AUTHOR = getEditorialAuthor({
  path: '/insights/top-healthcare-market-research-companies-brazil-2026',
  pageType: 'comparison',
});
...
const firms: FirmProfile[] = [
  {
    ...
    strengths: [
      ...
      '38-country network, 118 global clients, 15+ years primary research experience',
    ],
...
export default function TopHealthcareMarketResearchCompaniesBrazil2026() {
  return (
    <>
      <Helmet>
        <title>Brazil Healthcare Market Research Firms 2026 | BioNixus</title>
