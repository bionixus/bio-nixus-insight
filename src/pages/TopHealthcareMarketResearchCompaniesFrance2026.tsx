...
const PAGE_AUTHOR = getEditorialAuthor({
  path: '/insights/top-healthcare-market-research-companies-france-2026',
  pageType: 'comparison',
});
...
export default function TopHealthcareMarketResearchCompaniesFrance2026() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Top Healthcare Market Research Companies in France (2026)', item: PAGE_CANONICAL },
    ],
  };
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>France Healthcare Market Research Companies 2026 | BioNixus</title>
        <meta
          name="description"
