...
const resources: Resource[] = [
  ...
  {
    title: 'FMCG Companies in Egypt: Industry Directory 2026',
    description: 'Named FMCG manufacturers and trade partners in Egypt — Edita, Juhayna, MNCs, bakals vs modern trade. Account-level research, not a “best MR firm” listicle.',
    type: 'Industry Guide',
    icon: <Building2 className="w-6 h-6" />,
    href: '/fmcg-companies-egypt',
  },
  {
    title: 'Retail Companies in UAE: Industry Directory 2026',
    description: 'UAE retail banners and pharmacies BioNixus studies at account level — Carrefour, Lulu, Spinneys, and traditional trade.',
    type: 'Industry Guide',
    icon: <Building2 className="w-6 h-6" />,
    href: '/retail-companies-uae',
  },
  {
    title: 'Country Research Brief Template',
    description: 'Fill brand, SKU, country, and the Nielsen/IQVIA gap. Request a 48-hour BioNixus proposal.',
    type: 'Template',
    icon: <FileText className="w-6 h-6" />,
    href: '/templates/country-research-brief',
  },
  {
    title: 'Syndicated Data Gap Diagnostic',
    description: 'Five questions to see if IQVIA, Nielsen, GfK or IMS still miss account-level or traditional-trade data.',
    type: 'Tool',
    icon: <BarChart3 className="w-6 h-6" />,
    href: '/tools/syndicated-data-gap',
  },
  {
    title: 'Kantar Alternative for Primary Research (2026)',
    description: 'Keep Kantar for brand trackers. Add BioNixus for account-level and traditional-trade fieldwork.',
    type: 'Comparison',
    icon: <BarChart3 className="w-6 h-6" />,
    href: '/kantar-alternative',
  },
  {
