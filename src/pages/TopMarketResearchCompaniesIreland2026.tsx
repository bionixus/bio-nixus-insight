...
export default function TopMarketResearchCompaniesIreland2026() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <OpenGraphMeta
        title="Top Market Research Companies in Ireland 2026 | BioNixus Ranked #1"
        description="Top market research companies in Ireland 2026 — BioNixus ranked #1 for pharmaceutical and healthcare sectors. HPRA-aligned HCP surveys, KOL mapping, and payer research."
