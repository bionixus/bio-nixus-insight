...
const faqItems = [
  ...
  { q: 'How do VPAG and NHS England contracting affect UK pharma launches in 2026?', a: 'The Voluntary Scheme for Branded Medicines Pricing, Access and Growth (VPAG) caps industry-wide branded spend growth, pushing manufacturers toward stronger value evidence at NICE and ICS formulary level. Integrated Care Systems increasingly control prescribing budgets — launch research must map sub-national committee behaviour, not only national appraisal outcomes.' },
  { q: 'Where should medtech and pharma teams start UK market research?', a: 'Most programmes combine NHS Trust and primary-care physician sampling with payer and pharmacy stakeholder depth. BioNixus links this directory to dedicated UK pharmaceutical market research, MHRA/NICE-aware access modules, and the healthcare market research UK hub for methodology detail.' },
];
      ...
      <main>
        <LegacyDirectoryChrome
          breadcrumbs={[
            ...
            { name: 'Pharmaceutical Companies in the UK', href: '/pharmaceutical-companies-uk' },
          ]}
          h1="Pharmaceutical Companies in the UK"
          lead={
            <>
              The United Kingdom remains one of Europe&apos;s most important pharmaceutical markets, home to GSK and AstraZeneca and a dense network of multinational affiliates serving the NHS. Pharmaceutical companies in the UK navigate MHRA licensing and NICE appraisal pathways — start from <Link to="/healthcare-market-research">healthcare market research</Link> for programme scoping. This guide covers major manufacturers, distributors, regulatory context, and strategic opportunities.
            </>
          }
          metaLine="Last updated: August 2026 · Sources: MHRA, NICE, NHS, company filings, BioNixus research"
          stats={[
            { value: 'Top EU5', label: 'Among Europe\'s largest markets' },
            { value: 'NHS', label: 'Dominant purchaser' },
            { value: 'MHRA', label: 'Medicines regulator' },
            { value: 'NICE', label: 'HTA / uptake gatekeeper' },
          ]}
          jumpItems={[
          ...
          proposalLabel="Request a UK proposal"
          citationUrl={citationUrl}
          citeHeadline="Pharmaceutical Companies in the UK: Complete Industry Guide 2026"
          citeMonthYear="Aug. 2026"
        />
        ...
        <section className="section-padding py-16 bg-muted/30" id="top-companies"><div className="container-wide max-w-5xl mx-auto">
          ...
          <PharmaDirectoryBridge
            ...
            countryDisplay="the UK"
            directorySlug="uk"
            ctaId="pharma_companies_uk_after_table"
          />
        </div></section>
        ...
        <section className="section-padding py-10" id="country-directories"><div className="container-wide w-full">
          <CountryDirectoryLinks country="uk" excludePath="/pharmaceutical-companies-uk" compact />
        </div></section>
