...
export default function ArMarketResearchEgypt() {
  return (
    <MarketResearchCountryLanding
      ...
      description="صفحة BioNixus لأبحاث السوق الدوائي والصحي في مصر: مقابلات وميدان عربي/إنجليزي، أدلة داعمة للوصول، روابط دليل الشركات الدوائية، وحالات استخدام قبل الإطلاق أو التوسعة."
      ...
      relatedLinks={[
        ...
        { to: '/ar/strategic-portfolio', label: 'الملف الاستراتيجي لبيونيكسس' },
