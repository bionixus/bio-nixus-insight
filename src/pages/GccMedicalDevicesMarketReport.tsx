...
const GccMedicalDevicesMarketReport = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      <SEOHead
        title="GCC Medical Devices Market Report 2026 | IVD $5.8B Size | BioNixus"
        description="GCC medical devices market report 2026: in vitro diagnostic (IVD) market ~USD 5.8B, $9B+ by 2030. Saudi Arabia, UAE, Kuwait — SFDA, MOHAP, DHA regulation, prefilled syringes & hospital procurement."
