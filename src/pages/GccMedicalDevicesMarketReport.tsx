...
const GccMedicalDevicesMarketReport = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      <SEOHead
        title="GCC Medical Devices Market 2026 | SFDA & IVD | $5.8B Size | BioNixus"
        description="GCC medical devices & IVD market ~USD 5.8B in 2026. Saudi 52% share, SFDA MDIR, UAE MOHAP/DHA — hospital procurement intelligence & regulatory timelines from BioNixus."
