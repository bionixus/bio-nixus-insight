  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <SEOHead
        ...
        description="GCC medical devices & in vitro diagnostic (IVD) market ~USD 5.8B in 2026, $9B+ by 2030. Saudi Arabia, UAE, Kuwait — SFDA, MOHAP, DHA regulation, prefilled syringes & hospital procurement."
