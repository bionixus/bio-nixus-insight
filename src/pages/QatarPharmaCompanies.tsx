    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <section className="section-padding pt-0 pb-12"><div className="container-wide max-w-5xl mx-auto">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed max-w-3xl mb-4">Pharmaceutical companies in Qatar sit in the highest per-capita healthcare spend band in MENA — explore <Link to="/healthcare-market-research" className="text-primary font-medium hover:underline">healthcare market research</Link> across the Gulf. This guide covers major pharma companies, MOPH regulatory framework, Qatar National Vision 2030, market data, distribution channels (Hamad Medical Corp, Sidra Medicine), and strategic opportunities.</p>
