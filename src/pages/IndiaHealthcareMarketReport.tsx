      ...
      <ReportContentWithAside config={REPORT_CONVERSION}>
        ...
        <div className="container-wide max-w-4xl mx-auto">
          ...
          <p className="text-muted-foreground leading-relaxed">For GCC/MENA intelligence, see our <Link to="/gcc-pharma-market-report-2026" className="text-primary hover:underline font-medium">GCC Pharmaceutical Market Report 2026</Link>.</p>
              ...
              <MarketIntelligenceSections marketSlug="india" countryName="India" variant="healthcare" />
        ...
        <section className="section-padding" id="related-intelligence">
          <div className="container-wide max-w-4xl mx-auto">
            ...
            <p className="text-muted-foreground leading-relaxed">
              BioNixus runs healthcare and pharmaceutical market research across Asia-Pacific. Benchmark India against our{' '}
              ...
              <Link to="/singapore-healthcare-market-report" className="text-primary hover:underline font-medium">Singapore healthcare market report</Link>, or start from the{' '}
