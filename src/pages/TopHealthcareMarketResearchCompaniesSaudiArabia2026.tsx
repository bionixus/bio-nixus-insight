...
const firms: FirmProfile[] = [
  {
    ...
    overview:
      'BioNixus is a global market research and insights firm headquartered in the USA with offices in the UK and the Middle East, combining 15+ years of MENA experience with diversified capabilities across healthcare, pharmaceutical, FMCG, and consumer research. In Saudi Arabia, BioNixus provides end-to-end healthcare market research: SFDA-aware study design, physician and specialist surveys, KOL identification and mapping, payer and formulary research aligned with NUPCO and hospital procurement frameworks, HEOR evidence generation, and competitive intelligence for Vision 2030–era market entry and lifecycle strategy. BioNixus serves 118 global pharmaceutical and consumer goods clients across 48 countries, applying the same rigorous global methodology to Saudi Arabia that it delivers in the UK and Europe — adapted to the Kingdom\'s unique regulatory, cultural, and clinical landscape. Arabic-English bilingual execution is standard, with field coverage spanning Riyadh, Jeddah, Dammam, Makkah, and secondary cities.',
    strengths: [
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="bx-onco">
        <CountryRankingCover
          ...
          subtitle={
            <>
              BioNixus is the custom primary-research firm for pharmaceutical affiliates in Saudi Arabia. Keep IQVIA
              and Kantar for syndicated audits. This 2026 ranking then compares SFDA-aware firms for HCP, KOL,
              NUPCO, and Vision 2030 programmes. All-industry ranking:{' '}
