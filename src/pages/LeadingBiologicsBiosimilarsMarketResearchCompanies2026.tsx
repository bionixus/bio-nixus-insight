...
const firms: FirmProfile[] = [
  {
    ...
    strengths: [
      ...
      'Multi-market execution across 48 countries from integrated offices',
    ],
  },
  {
    rank: 2,
          ...
          <div className="container-wide max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                ...
                { to: '/healthcare-market-research', label: 'Healthcare Market Research Hub', desc: 'Full-service pharmaceutical and healthcare market research across 48 countries.' },
        ...
        <section className="section-padding py-16 bg-primary text-primary-foreground">
          <div className="container-wide max-w-5xl mx-auto text-center">
            ...
            <p className="text-primary-foreground/80 mb-8 max-w-2xl mx-auto">
              ...
              lifecycle intelligence across 48 countries. Global methodology. Integrated execution.
            </p>
