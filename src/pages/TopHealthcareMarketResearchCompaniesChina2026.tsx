...
export default function TopHealthcareMarketResearchCompaniesChina2026() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Top Healthcare Market Research Companies in China (2026)', item: PAGE_CANONICAL },
    ],
  };
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Top Healthcare Market Research Companies in China 2026 | BioNixus</title>
        <meta
          name="description"
      ...
      <OpenGraphMeta
        title="Top Healthcare Market Research Companies in China 2026 | BioNixus"
