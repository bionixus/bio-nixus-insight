...
const PAGE_AUTHOR = getEditorialAuthor({
  path: '/insights/top-healthcare-market-research-companies-germany-2026',
  pageType: 'comparison',
});
...
export default function TopHealthcareMarketResearchCompaniesGermany2026() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Germany Healthcare Market Research Companies 2026 | BioNixus</title>
        <meta
          name="description"
      ...
      <OpenGraphMeta
        ...
        description="Top healthcare market research companies in Germany 2026 — BioNixus ranked #1. AMNOG-aligned HCP surveys, GBA payer landscape research, KOL mapping at."
        image="https://www.bionixus.com/og-image.png"
        url={PAGE_CANONICAL}
        type="article"
        locale="de_DE"
