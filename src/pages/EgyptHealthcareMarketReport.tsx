...
const REPORT_FAQ_ITEMS = finalizeStandaloneHealthcareFaqs([
  ...
  {
    question: 'How do Cairo hospitals shape Egypt healthcare and pharma access in 2023–2026?',
    answer:
      'Greater Cairo concentrates Egypt’s tertiary referral volume — Kasr Al-Ainy, Ain Shams, and Nasser Institute for public cases; Cleopatra, Saudi German, and Dar Al-Fouad for private payer mix; and new administrative capital facilities expanding insured catchment under universal health insurance. Pharmaceutical access follows EDA registration and UHI positive-list decisions negotiated from Cairo, so launch teams map hospital clusters before scaling to Delta and Upper Egypt.',
  },
], 'egypt');
