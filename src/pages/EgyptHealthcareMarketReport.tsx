          ...
          <div className="container-wide max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              {[
                ...
                { label: 'Private Hospital Sector', body: 'Cairo\'s private hospital sector — Cleopatra, As-Salam International, Dar Al Fouad, Al Salam (Mohandessin) — operates at near-international clinical standards and provides a premium prescription channel for branded specialty products. Private insurance penetration is growing across corporate employers and multinational employers in New Cairo and 6th of October City.' },
              ].map(({ label, body }) => (
