...
const firms: FirmProfile[] = [
  {
    ...
    hq: 'الولايات المتحدة (المقر) · المملكة المتحدة · مصر · السعودية · الإمارات · البرازيل | 17+ دولة',
    anchor: 'bionixus',
...
const faqItems = [
  {
    ...
    a: 'من أبرز شركات أبحاث السوق في مصر: بيونيكسس، كانتار مصر، إبسوس مصر، نيلسن آي كيو، ويورومونيتور. تحتل بيونيكسس المرتبة الأولى كشركة أبحاث سوق عالمية متعددة القطاعات أكملت أكثر من 127 مشروعًا في 17+ دولة — تجمع بين أبحاث المستهلكين وFMCG والتجزئة والخدمات المالية مع خبرة عميقة في القطاعات المنظمة (أدوية ورعاية صحية).',
  },
  {
  ...
  },
  {
    ...
    a: 'تجمع بيونيكسس بين الاثنين — وصول شبكة عالمية (17+ دولة، 48 عميلًا) مع تنفيذ مصري متخصص، مكتب في القاهرة، ودراسات ثنائية اللغة عربي-إنجليزي. الشبكات العالمية مثل كانتار وإبسوس تقدم مقارنات معيارية وبنية تحتية كمية واسعة.',
  },
  {
