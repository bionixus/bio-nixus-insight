...
const UkMedicalDevicesMarketReport = () => (
  <div className="min-h-screen bg-background">
    ...
    <main>
      ...
      <FAQSection sectionId={FAQ_SECTION_ID} title="UK medical devices market 2026 — UKCA, MHRA, NHS Supply Chain, and procurement FAQ" items={REPORT_FAQ_ITEMS} className="bg-muted/30" />
      <section className="section-padding bg-primary/5" id="contact-cta">
        <div className="container-wide max-w-3xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-display font-semibold text-foreground mb-4">BioNixus London: GCC & MENA Intelligence for UK Medtech Teams</h2>
          <p className="text-muted-foreground leading-relaxed mb-8 max-w-2xl mx-auto">UK and European medical device companies expanding into GCC and MENA markets. BioNixus delivers MOHAP, SFDA, HMC regulatory intelligence and hospital procurement data from London and Cairo.</p>
