        ...
        <section className="section-padding bg-primary/5" id="contact-cta">
          <div className="container-wide max-w-3xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-display font-semibold text-foreground mb-4">
              Request the BioNixus Bahrain Healthcare Market Intelligence Briefing
            </h2>
            <p className="text-muted-foreground leading-relaxed mb-8 max-w-2xl mx-auto">
              NHRA registration strategy, MOH Bahrain formulary access, physician panel surveys, and GCC sequential entry planning support.
            </p>
