...
const PAGE_DESCRIPTION =
  'GCC biologics market ($4.8–5.4B), generic injectables ($1.6–1.9B), NUPCO tender intelligence, biosimilar penetration & Saudi precision medicine — pharmaceutical market research across KSA, UAE, Kuwait, Qatar, Bahrain & Oman.';
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      'NUPCO centralises Saudi Ministry of Health pharmaceutical tenders — so research programmes must track tender calendars, committee evaluation criteria, and post-award physician switching, not only SFDA approval status. BioNixus sequences quantitative prescribing trackers and qualitative procurement interviews around NUPCO award windows so launch and access teams can defend originator share or plan biosimilar entry with ward-level evidence.',
  },
];
