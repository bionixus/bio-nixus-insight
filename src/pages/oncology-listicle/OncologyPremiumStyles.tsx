...
import { ONCOLOGY_PREMIUM_CSS } from './oncologyPremiumCss';

/** Injects scoped oncology listicle CSS into <head> (valid HTML). */
export function OncologyPremiumStyles() {
  return (
    <Helmet>
      ...
      <link
        ...
        rel="stylesheet"
      />
      <style type="text/css">{ONCOLOGY_PREMIUM_CSS}</style>
    </Helmet>
  );
}
