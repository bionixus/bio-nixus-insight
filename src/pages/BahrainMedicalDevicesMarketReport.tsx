        ...
        <section className="section-padding pb-10">
          <div className="container-wide max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl md:text-5xl font-display font-bold text-foreground mb-6">
              Bahrain Medical Devices Market Report 2026: NHRA Registration, GCC Sequential Entry, and Commercial Strategy
            </h1>
            <p className="text-muted-foreground leading-relaxed">
              BioNixus covers Bahrain medical devices as part of GCC-wide programs — NHRA registration tracking,
