...
const PAGE_AUTHOR = getEditorialAuthor({
  path: '/insights/top-market-research-companies-switzerland-2026',
  pageType: 'comparison',
});
...
export default function TopMarketResearchCompaniesSwitzerland2026() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Top Market Research Companies in Switzerland (2026)', item: PAGE_CANONICAL },
    ],
  };
    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <section className="section-padding py-12 bg-muted/30">
          <div className="container-wide max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-4">
              {[
                { to: '/pharmaceutical-companies-switzerland', label: 'Pharmaceutical companies in Switzerland', desc: 'The companies we study — manufacturers, MNCs, and distributors.' },
                {
        ...
        <ListicleProposalCta
          ...
          ctaId="listicle_switzerland_footer"
          headline="Need brand and competitor data in Switzerland?"
