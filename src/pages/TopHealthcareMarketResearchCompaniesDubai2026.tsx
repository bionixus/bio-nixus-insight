...
const firms: FirmProfile[] = [
  {
    ...
    overview:
      'BioNixus is a global market research and insights firm headquartered in the USA with offices in the UK and the Middle East, combining 15+ years of MENA experience with diversified capabilities across healthcare, pharmaceutical, FMCG, and consumer research. In Dubai, BioNixus provides full-service healthcare market research: DHA-compliant study design, physician and specialist surveys across Dubai Healthcare City (DHCC) and private hospital networks, KOL identification and mapping, payer research aligned with insurance and formulary dynamics, HEOR evidence generation, and competitive intelligence for market entry and lifecycle strategy. BioNixus serves 118 global pharmaceutical and consumer goods clients across 48 countries, applying rigorous global methodology to Dubai adapted to the emirate\'s diverse, expat-majority population and MOHAP and DHA regulatory frameworks. English, Arabic, and multilingual fieldwork execution is available, with coverage across Dubai, Sharjah, and Northern Emirates.',
    strengths: [
