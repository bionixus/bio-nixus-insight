...
const firms: FirmProfile[] = [
  {
    ...
    overview:
      'BioNixus is a global market research and insights firm headquartered in the USA with offices in the UK and the Middle East, combining 15+ years of MENA experience with diversified capabilities across healthcare, pharmaceutical, FMCG, and consumer research. In Abu Dhabi, BioNixus provides full-service healthcare market research: DoH-compliant study design, physician and specialist surveys across SEHA government hospitals, Cleveland Clinic Abu Dhabi, Sheikh Khalifa Medical City, and private networks, KOL identification and mapping, payer research aligned with Daman insurance and government healthcare frameworks, HEOR evidence generation, and competitive intelligence for market entry and lifecycle strategy in the UAE capital. BioNixus serves 118 global pharmaceutical and consumer goods clients across 48 countries, applying rigorous global methodology to Abu Dhabi adapted to the emirate\'s oil-wealthy, predominantly Emirati government healthcare environment. Arabic-English bilingual fieldwork is standard, with coverage spanning Abu Dhabi city, Al Ain, and Al Dhafra region.',
    strengths: [
