...
const firms: FirmProfile[] = [
  {
    ...
    strengths: [
      ...
      'Endocrinologist and obesity specialist HCP surveys across 48 countries',
      ...
      '118 global pharma clients with dedicated metabolic disease research teams',
    ],
  },
  {
    rank: 2,
          ...
          <div className="container-wide max-w-5xl mx-auto">
            <div className="bg-card border border-border rounded-xl p-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-3">
                ...
                patient journey mapping, and payer market access strategy across 48 countries.
              </p>
          ...
          <div className="container-wide max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                ...
                { to: '/healthcare-market-research', label: 'Healthcare Market Research', desc: 'Full-service pharmaceutical market research across 48 countries.' },
        ...
        <section className="section-padding py-16 bg-primary text-primary-foreground">
          <div className="container-wide max-w-5xl mx-auto text-center">
            ...
            <p className="text-primary-foreground/80 mb-8 max-w-2xl mx-auto">
              ...
              and multi-market HCP surveys across 48 countries including high-prevalence GCC markets. Global
