...
const PAGE_AUTHOR = getEditorialAuthor({
  path: '/insights/top-market-research-companies-china-2026',
  pageType: 'comparison',
});
...
export default function TopMarketResearchCompaniesChina2026() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Top Market Research Companies in China (2026)', item: PAGE_CANONICAL },
    ],
  };
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <OpenGraphMeta
        title="Top Market Research Companies in China 2026 | BioNixus"
        description="Top market research companies in China 2026 — BioNixus ranked #1 for pharmaceutical and healthcare sectors. HCP surveys at Tier 3A hospitals, NHSA NRDL."
        image="https://www.bionixus.com/og-image.png"
        url={PAGE_CANONICAL}
        type="article"
        locale="zh_CN"
      ...
      <main>
        ...
        <section className="section-padding py-12 bg-muted/30">
          <div className="container-wide max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                { to: '/pharmaceutical-companies-china', label: 'Pharmaceutical companies in China', desc: 'The companies we study — manufacturers, MNCs, and distributors.' },
                {
                  to: '/insights/top-healthcare-market-research-companies-china-2026',
        ...
        <ListicleProposalCta
          countryName="China"
          ctaId="listicle_china_footer"
          headline="Need brand and competitor data in China?"
