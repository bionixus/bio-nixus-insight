...
export default function HubPage() {
  ...
  const hubSeoTitle =
    typeof hubContent?.metaTitle === 'string' && hubContent.metaTitle.length > 0
      ...
      : 'Healthcare Market Research Companies | USA, Europe, GCC & MENA | BioNixus';
  const hubSeoDescription =
    typeof hubContent?.metaDescription === 'string' && hubContent.metaDescription.length > 0
      ...
      : 'Healthcare market research company for pharma & medtech — physician surveys, payer access, and hospital evidence across USA, Europe, GCC, MENA, and Asia-Pacific. US HQ, 20+ country hubs, ESOMAR-compliant.';
  const heroTitle =
