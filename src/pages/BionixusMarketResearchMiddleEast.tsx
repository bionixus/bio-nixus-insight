        ...
        <section className="section-padding py-6">
          <div className="container-wide max-w-6xl mx-auto rounded-2xl border border-border bg-card p-5 md:p-6">
            ...
            <div className="mt-3 grid md:grid-cols-2 lg:grid-cols-4 gap-3">
              ...
              <Link to="/brand-tracking-pharma-gcc" className="text-sm text-primary hover:underline">
                Brand tracking pharma GCC
              </Link>
              <Link to="/commercial-effectiveness-pharma-middle-east" className="text-sm text-primary hover:underline">
                Commercial effectiveness pharma Middle East
              </Link>
              <Link to="/patient-journey-research-gcc" className="text-sm text-primary hover:underline">
          ...
          <div className="container-wide max-w-5xl mx-auto">
            <article className="rounded-xl border border-border bg-card p-6">
              ...
              <WorkEmailRequestForm
                destination="notify"
                formId="middle_east_page_report_brief"
                ...
                successBody="We will send the GCC Pharmaceutical Research Brief to your work email shortly."
              />
            </article>
          </div>
        </section>
