...
const REPORT_FAQ_ITEMS = finalizeStandaloneHealthcareFaqs([
  ...
  },
  {
    ...
    answer: 'Brazil\'s medical devices market is estimated at USD 11–13 billion in 2026 — the largest in Latin America. ANVISA regulates device registration with INMETRO certification for electrical equipment; SUS procurement and ANS-regulated private hospitals create dual commercial channels similar to pharmaceuticals. Implant, diagnostic, and surgical segments each follow distinct CONITEC and hospital procurement rhythms — see the Brazil medical devices market report for segment detail, ANVISA pathway context, and SUS versus private channel comparisons.',
  },
], 'brazil');
