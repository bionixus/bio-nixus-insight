...
const BrazilHealthcareMarketReport = () => (
  <div className="min-h-screen bg-background">
    ...
    <main>
      ...
      <FAQSection sectionId={FAQ_SECTION_ID} title="Brazil healthcare market 2026 — ANVISA, SUS, CONITEC, ANS, and CMED pricing FAQ" items={REPORT_FAQ_ITEMS} className="bg-muted/30" />
      <section className="section-padding bg-primary/5" id="contact-cta">
        <div className="container-wide max-w-3xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-display font-semibold text-foreground mb-4">BioNixus: GCC & MENA Intelligence for Brazilian and LatAm Pharma Companies</h2>
          <p className="text-muted-foreground leading-relaxed mb-8 max-w-2xl mx-auto">Brazilian and Latin American pharmaceutical companies expanding into GCC and MENA markets. BioNixus delivers Saudi Arabia, UAE, Kuwait, Qatar, Bahrain, Oman, and Egypt market intelligence from London and Cairo.</p>
