...
const PHARMA_CONVERSION = getPharmaGuideConfig('saudi-arabia');
    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <section className="section-padding py-16 bg-muted/30" id="regulatory-landscape"><div className="container-wide max-w-5xl mx-auto">
          ...
          <p className="text-muted-foreground mb-10 max-w-3xl">The Saudi Food and Drug Authority (SFDA) is one of the most sophisticated pharmaceutical regulators in the Middle East, increasingly aligned with ICH guidelines. For the full step-by-step process, timelines, and fees, see our <Link to="/blog/sfda-drug-registration-guide" className="text-primary hover:underline">SFDA drug registration guide to pharmaceutical product registration in Saudi Arabia</Link>.</p>
        ...
        <section className="section-padding py-16" id="distribution-channels"><div className="container-wide max-w-5xl mx-auto">
          ...
          <p className="text-muted-foreground mb-10 max-w-3xl">Saudi Arabia&apos;s pharmaceutical distribution operates through government and private channels, with retail pharmacy chains playing an increasingly important role. See the ranked <Link to="/top-pharmacies-saudi-arabia" className="text-primary hover:underline">top 10 pharmacies in Saudi Arabia</Link> for the retail channel landscape.</p>
          <div className="grid md:grid-cols-2 gap-8">
