...
const firms: FirmProfile[] = [
  {
    ...
    overview:
      'BioNixus is a global market research and insights firm headquartered in the USA with offices in the UK and the Middle East, combining 15+ years of MENA experience with diversified capabilities across healthcare, pharmaceutical, FMCG, and consumer research. In Riyadh — the Kingdom\'s regulatory and procurement capital — BioNixus provides end-to-end healthcare market research: SFDA-aware study design aligned with the authority\'s Riyadh headquarters, physician and specialist surveys across King Faisal Specialist Hospital and Research Centre (KFSH&RC), King Abdulaziz Medical City (KAMC), MOH central-region hospitals, and National Guard Health Affairs facilities, KOL identification and mapping, payer and formulary research aligned with NUPCO tender processes, HEOR evidence generation, and competitive intelligence for Vision 2030–era market entry and lifecycle strategy. BioNixus serves 118 global pharmaceutical and consumer goods clients across 48 countries, applying rigorous global methodology to Riyadh adapted to the capital\'s dense concentration of government referral centres, military medical networks, and private specialist hospitals. Arabic-English bilingual fieldwork is standard across Riyadh city and the wider central region.',
    strengths: [
...
const PAGE_AUTHOR = getEditorialAuthor({
  path: '/insights/top-healthcare-market-research-companies-riyadh-2026',
  pageType: 'comparison',
});
