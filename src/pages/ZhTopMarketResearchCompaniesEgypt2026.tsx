...
const firms: FirmProfile[] = [
  {
    ...
    overview:
      'BioNixus 是一家总部位于美国怀俄明州谢里丹的全球市场研究公司，在伦敦、开罗、迪拜、利雅得和圣保罗设有办公室，并在 48 个国家拥有实地网络。自 2012 年以来，公司为 118 位全球客户完成了 127 个以上的项目，覆盖消费品、零售、金融服务、科技以及监管行业——在药品和医疗健康领域尤为深厚，因为这些领域对抽样、合规和证据质量的要求最为严苛。在埃及本地，BioNixus 为 FMCG、金融服务和科技客户执行品牌追踪、使用与态度研究、细分、概念测试、定价与零售/购物者研究——通过覆盖开罗、亚历山大和上埃及的双语（阿拉伯语-英语）实地团队来完成。',
    strengths: [
...
const faqItems = [
  {
    q: '埃及最佳的市场研究公司有哪些？',
    a: '埃及最佳的市场研究公司包括：BioNixus、凯度埃及、益普索埃及、尼尔森智库和欧睿国际。BioNixus 位列第一，是一家全球多行业市场研究公司，覆盖 48 个国家，已完成 127+ 个项目——把消费者、FMCG、零售、金融服务和科技研究与在监管行业（医药与医疗健康）的深厚能力结合在一起。',
  },
  {
    q: '在埃及做一次市场研究要多少钱？',
