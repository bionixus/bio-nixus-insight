  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta name="description" content="Pharmaceutical companies in Oman: 18+ companies, $0.7B market, MOH DGPA registration, Vision 2040 — ranked manufacturers, MNC offices, and distributors (2026)." />
      ...
      <main>
        ...
        <section className="section-padding pt-0 pb-12"><div className="container-wide max-w-5xl mx-auto">
          ...
          <p className="text-sm text-muted-foreground">Last updated: June 2026 &middot; Sources: MOH DGPA, BioNixus MEA, company filings</p>
        ...
        <MarketResearchEquityLinks country="oman" />
