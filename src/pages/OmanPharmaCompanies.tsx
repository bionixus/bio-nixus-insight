...
const PHARMA_CONVERSION = getPharmaGuideConfig('oman');
...
const OmanPharmaCompanies = () => {
  ...
  const ogTitle = "Oman Pharma: Top Pharmaceutical Companies & Market Size (2026)";
  const ogDescription = "The definitive 2026 guide to Oman's pharma market — top companies, local manufacturers, market size and growth data. By Bionixus.";
  return (
    <div className="directory-page min-h-screen">
      <Helmet>
        <title>Top Pharmaceutical Companies in Oman (2026 Ranked List)</title>
        <meta name="description" content="Top pharmaceutical companies in Oman ranked for 2026 — local manufacturers, MNCs, market size and growth data. The definitive Oman pharma guide by BioNixus." />        <link rel="canonical" href={citationUrl} />
      ...
      />
      <Navbar />
      <ReportReadingProgress progressId="pharma-guide-rp-oman" />
      <main>
        <LegacyDirectoryChrome
          breadcrumbs={[
            { name: 'Home', href: basePath },
            { name: 'Resources', href: '/resources' },
            { name: 'Pharmaceutical Companies in Oman', href: '/pharmaceutical-companies-oman' },
          ]}
          h1="Pharmaceutical Companies in Oman"
          lead={
            <>
              Pharmaceutical companies in Oman operate inside the wider Gulf landscape — see our <Link to="/healthcare-market-research">healthcare market research</Link> hub for regional programmes. This guide covers major pharma companies, MOH DGPA regulatory framework, Vision 2040 healthcare modernisation, market data ($0.7B, 6.9% growth), distribution channels, and strategic opportunities.
            </>
          }
          metaLine="Last updated: February 2026 · Sources: MOH DGPA, BioNixus MEA, company filings"
          stats={[
            { value: '$0.7B', label: 'Pharmaceutical market value' },
            { value: '6.9%', label: 'Year-over-year growth' },
            { value: '4.6M', label: 'Population' },
            { value: '$152', label: 'Pharma spending per capita' },
          ]}
          jumpItems={[
          ...
          proposalLabel="Request an Oman proposal"
          citationUrl={citationUrl}
          citeHeadline="Pharmaceutical Companies in Oman: Complete Industry Guide 2026"
        ...
        <PharmaCompaniesQuickAnswer
          country="oman"
          marketSize="approximately USD 0.7 billion"
          growthRate="6.9% YoY"
          regulatorLabel="MOH Directorate General of Pharmaceutical Affairs (DGPA)"
        ...
        <section className="section-padding py-16 bg-muted/30" id="top-companies"><div className="container-wide max-w-5xl mx-auto">
          ...
          <PharmaDirectoryBridge
            countryName="Oman"
            directorySlug="oman"
            ctaId="pharma_companies_oman_after_table"
          />
        ...
        <section className="section-padding py-16" id="bionixus-support"><div className="container-wide max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-10">{[
            ...
            { title: 'Market Access & MOH DGPA Strategy', desc: 'MOH DGPA formulary strategy, GCC pricing context, reimbursement landscape, and payer research to optimize commercial success in Oman.' },
        ...
        <section className="section-padding py-16" id="gcc-directories"><div className="container-wide max-w-5xl mx-auto">
          ...
          <p className="text-muted-foreground mb-8 max-w-3xl">Compare the Oman pharmaceutical industry with BioNixus company directories for the other Gulf and MENA markets.</p>
        ...
        <section className="section-padding py-10" id="country-directories"><div className="container-wide w-full">
          <CountryDirectoryLinks country="oman" excludePath="/pharmaceutical-companies-oman" compact />
        </div></section>

        <PharmaCompaniesFaqSection items={faqItems} />

        <PharmaCompaniesGccHubLinks country="oman" />
        ...
        <div className="fixed bottom-0 left-0 right-0 z-40 bg-background border-t border-border shadow-lg p-4">
          <div className="container-wide max-w-3xl mx-auto">
            <ConversionCTA
              ...
              ctaId="pharma_companies_oman_scroll70"
