    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <section className="section-padding pt-0 pb-12"><div className="container-wide max-w-5xl mx-auto">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed max-w-3xl mb-4">Pharmaceutical companies in Oman operate inside the wider Gulf landscape — see our <Link to="/healthcare-market-research" className="text-primary font-medium hover:underline">healthcare market research</Link> hub for regional programmes. This guide covers major pharma companies, MOH DGPA regulatory framework, Vision 2040 healthcare modernisation, market data ($0.7B, 6.9% growth), distribution channels, and strategic opportunities.</p>
          <p className="text-sm text-muted-foreground">Last updated: February 2026 &middot; Sources: MOH DGPA, BioNixus MEA, company filings</p>
