...
export default function TopMarketResearchCompaniesSweden2026() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <OpenGraphMeta
        title="Top Market Research Companies in Sweden 2026 | BioNixus Ranked #1"
        description="Top market research companies in Sweden 2026 — BioNixus ranked #1 for pharmaceutical and healthcare sectors. Läkemedelsverket-aligned HCP surveys, KOL mapping, and TLV payer research."
