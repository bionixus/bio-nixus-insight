...
const PAGE_AUTHOR = getEditorialAuthor({
  path: '/insights/top-market-research-companies-india-2026',
  pageType: 'comparison',
});
...
export default function TopMarketResearchCompaniesIndia2026() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Top Market Research Companies in India 2026 | BioNixus</title>
        <meta
          name="description"
      ...
      <main>
        ...
        <section className="section-padding py-12 bg-muted/30">
          <div className="container-wide max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                { to: '/pharmaceutical-companies-india', label: 'Pharmaceutical companies in India', desc: 'The companies we study — manufacturers, MNCs, and distributors.' },
                {
                  to: '/insights/top-healthcare-market-research-companies-india-2026',
        ...
        <ListicleProposalCta
          countryName="India"
          ctaId="listicle_india_footer"
          headline="Need brand and competitor data in India?"
