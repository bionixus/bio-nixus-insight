    ...
    <main>
      ...
      <section className="section-padding pb-10">
        <div className="container-wide max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-5xl font-display font-bold text-foreground mb-6">Singapore Medical Devices Market Report 2026: HSA Regulation, ASEAN Distribution Hub, and Medical Tourism Intelligence</h1>
          <p className="text-muted-foreground leading-relaxed">BioNixus delivers Singapore and Southeast Asia medical device market intelligence — HSA regulatory tracking, ASEAN distribution strategy, hospital procurement research, and GCC/MENA market entry intelligence for Singapore-based and international medtech companies.</p>
        </div>
      </section>
      ...
      <FAQSection sectionId={FAQ_SECTION_ID} title="Singapore medical devices market 2026 — HSA, Access Consortium, ASEAN hub, medical tourism, and GCC FAQ" items={REPORT_FAQ_ITEMS} className="bg-muted/30" />
      <section className="section-padding bg-primary/5" id="contact-cta">
        <div className="container-wide max-w-3xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-display font-semibold text-foreground mb-4">BioNixus: GCC & MENA Intelligence for Singapore and Asia-Pacific MedTech</h2>
          <p className="text-muted-foreground leading-relaxed mb-8 max-w-2xl mx-auto">Singapore and Asia-Pacific medical device companies expanding into GCC and MENA markets. BioNixus delivers regulatory intelligence, hospital procurement data, and distributor mapping across Saudi Arabia, UAE, and the wider region.</p>
