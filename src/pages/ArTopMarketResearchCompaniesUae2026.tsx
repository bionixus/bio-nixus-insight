...
const firms: FirmProfile[] = [
  {
    ...
    overview:
      'بيونيكسس شركة أبحاث سوق عالمية منذ 2012، أكملت أكثر من 127 مشروعاً لـ 118 عميلاً عالمياً. في الإمارات تُنفّذ تتبع العلامات التجارية ودراسات الاستخدام والمواقف والتجزئة واختبارات المفاهيم والتسعير وأبحاث المتسوقين — مع تنفيذ ميداني متعدد اللغات في دبي وأبوظبي والإمارات الشمالية، ومنهجيات منضبطة مستمدة من قطاع الأدوية والرعاية الصحية.',
    strengths: [
...
const faqItems = [
  ...
  },
  {
    ...
    a: 'نعم. بيونيكسس تعمل منذ 2012 مع أكثر من 127 مشروعاً و118 عميلاً عالمياً، وتنفيذ إماراتي عبر المستهلكين وFMCG والرعاية الصحية والقطاعات المتعددة. راسل admin@bionixus.com للحصول على اقتراح خلال 48 ساعة.',
  },
];
