...
export default function ArMarketResearchKuwait() {
  return (
    <MarketResearchCountryLanding
      ...
      description="أبحاث السوق الدوائي في الكويت: تركيز على المسارات المجمّعة بين المستودع المركزي والقطاع الخاص، وبرامج أدلة قائمة على الميدان العربي مع روابط لخدمات المنطقة وحالات التوسعة."
