...
const content: GeneralMRPageContent = {
  ...
  whyBionixus: {
    ...
    points: [
      'Global market research company — USA HQ, UK and Middle East offices — with 15+ years of experience in 48 countries',
...
export default function MarketResearchInSaudiArabia() {
