...
const BahrainPharmaCompanies = () => {
  ...
  const ogTitle = "Pharmaceutical Companies in Bahrain: 2026 Ranked List & Data";
      ...
      <main>
        ...
        <section className="section-padding py-16 bg-muted/30" id="top-companies"><div className="container-wide w-full">
          ...
          <PharmaDirectoryBridge
            countryName="Bahrain"
            directorySlug="bahrain"
            ctaId="pharma_companies_bahrain_after_table"
          />
        ...
        <section className="section-padding py-10" id="country-directories"><div className="container-wide w-full">
          <CountryDirectoryLinks country="bahrain" excludePath="/pharmaceutical-companies-bahrain" compact />
        </div></section>
        ...
        <div className="fixed bottom-0 left-0 right-0 z-40 bg-background border-t border-border shadow-lg p-4">
          <div className="container-wide max-w-3xl mx-auto">
            <ConversionCTA
              ...
              ctaId="pharma_companies_bahrain_scroll70"
