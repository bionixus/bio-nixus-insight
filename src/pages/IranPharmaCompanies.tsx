      ...
      <main>
        ...
        <section className="section-padding py-16" id="market-overview"><div className="container-wide max-w-5xl mx-auto">
          ...
          <div className="prose-body text-muted-foreground leading-relaxed space-y-4 max-w-4xl">
            ...
            <p>
              Hospital and pharmacy channel dynamics remain opaque in syndicated audits: university hospitals (Tehran, Shiraz, Mashhad) anchor KOL influence while Darou Pakhsh Distribution and regional wholesalers control last-mile availability. BioNixus Iran programmes combine verified physician and pharmacist interviews with distributor mapping so manufacturers understand where IFDA-listed products actually reach shelves versus where formulary intent stalls in procurement.
            </p>
          </div>
        </div></section>
