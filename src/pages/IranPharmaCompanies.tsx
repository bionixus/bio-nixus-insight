...
const faqItems = [
  ...
  { q: 'Which Iranian pharma companies export to GCC and MENA markets?', a: 'Several Iranian manufacturers — including Cinnagen, Sobhan Pharmaceutical, and Exir — supply biosimilars and generics to neighbouring MENA markets where sanctions-compliant trade routes exist. Export strategy requires understanding each destination\'s registration (SFDA, MOHAP, EDA) and distributor requirements separately from IFDA domestic approval. BioNixus supports comparative Iran-to-GCC market intelligence for manufacturers evaluating compliant regional expansion.' },
];
