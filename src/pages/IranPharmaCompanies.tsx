...
const PHARMA_CONVERSION = getPharmaGuideConfig('iran');
...
const faqItems = [
  ...
  { q: 'Who are the largest pharmaceutical distributors in Iran?', a: 'Darou Pakhsh Distribution is the largest pharmaceutical distributor, linked to the Darou Pakhsh manufacturing group. Hakim Distribution, TPICO (Tehran Pharma Investment Co.), and regional wholesalers serve Tehran, Isfahan, Mashhad, and Tabriz corridors. Distribution is tightly linked to IFDA pricing and quota allocation — foreign manufacturers typically partner with an established distributor rather than building standalone logistics.' },
  { q: 'Which Iranian cities concentrate pharmaceutical manufacturing?', a: 'Tehran and Karaj host the largest concentration of manufacturers (Darou Pakhsh, Sobhan, Cinnagen). Isfahan, Shiraz, and Tabriz have growing generic and biosimilar clusters. Export-oriented plants in free-trade zones supply regional markets despite sanctions constraints. BioNixus maps manufacturing versus consumption geography when teams assess partnership or licensing opportunities.' },
  { q: 'How does Iran compare to GCC markets for pharma exporters?', a: 'Iran is self-sufficient (~95% local production) with government-controlled pricing — unlike import-dependent GCC markets where NUPCO and MOHAP tenders dominate. GCC affiliates seeking Iran intelligence usually need partner diligence, biosimilar capability assessment, and post-sanctions scenario planning rather than standard tender playbooks.' },
  { q: 'What therapeutic areas drive Iran pharmaceutical growth?', a: 'Oncology, diabetes (including biosimilar insulin), cardiovascular generics, and vaccines lead volume growth. Biosimilars and biologics developed under sanctions pressure (Cinnagen EPO, Sobhan insulin) are export-capable. Rare-disease and innovative molecules remain import-dependent through distributor channels when permitted.' },
];
...
const IranPharmaCompanies = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Top 18 Pharmaceutical Companies in Iran (2026 Ranked List)</title>
        <meta name="description" content="Top 18 pharmaceutical companies in Iran ranked for 2026 — market size, sanctions context, local manufacturers and access pathways. By BioNixus." />        <link rel="canonical" href={citationUrl} />
      ...
      />
      <Navbar />
      <ReportReadingProgress progressId="pharma-guide-rp-iran" />
      <main>
        ...
        <section className="section-padding pt-0 pb-12"><div className="container-wide max-w-5xl mx-auto">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed max-w-3xl mb-4">Pharmaceutical companies in Iran represent the MENA region&apos;s second-largest pharma market by volume — for Gulf and global context see <Link to="/healthcare-market-research" className="text-primary font-medium hover:underline">healthcare market research</Link>. This guide covers major pharma companies, IFDA regulatory framework, 95% local production, market data, distribution channels, and strategic opportunities.</p>
        ...
        <PharmaCompaniesQuickAnswer
          country="iran"
          marketSize="approximately USD 4.2 billion by volume"
          growthRate="second-largest MENA pharma market by volume"
          regulatorLabel="Iranian Food and Drug Administration (IFDA)"
        ...
        <PharmaCompaniesGccHubLinks country="iran" />
