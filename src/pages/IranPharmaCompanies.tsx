...
const faqItems = [
  ...
  { q: 'Who are the leading Iranian pharmaceutical manufacturers?', a: 'Darou Pakhsh (~10% market share), Sobhan (biologics and insulin), Razak (generics and exports), Cinnagen (biotech, EPO, insulin), and Exir (biosimilars and vaccines) anchor domestic production. BioNixus maps competitive dynamics through primary research when clients need field-validated share and capability intelligence beyond public lists.' },
  { q: 'How does BioNixus support pharmaceutical market research on Iran?', a: 'BioNixus provides competitive intelligence, IFDA pathway analysis, distribution mapping, and scenario planning for teams engaging with Iran\'s self-sufficient pharma sector — without substituting for legal or sanctions compliance advice. Research links to MENA and GCC hubs when regional portfolio decisions require comparative context.' },
];
