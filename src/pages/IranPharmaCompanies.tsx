    ...
    <div className="directory-page min-h-screen">
      ...
      <main>
        ...
        <PharmaCompaniesQuickAnswer
          ...
          extraSentence="Iran is one of the most self-sufficient pharma markets globally — roughly 95% local production — so competitive strategy turns on biosimilar depth, IFDA pricing, and distributor reach rather than import-led access models."
        />
