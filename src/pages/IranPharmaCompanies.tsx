...
const faqItems = [
  ...
  { q: 'Which Iranian pharmaceutical companies lead biosimilar production?', a: 'Sobhan Pharmaceutical (insulin), Cinnagen (EPO, insulin, biotechnology), and Exir Pharmaceutical (biosimilars, vaccines) are among the leading domestic biotech and biosimilar manufacturers. Darou Pakhsh remains the largest private manufacturer by market share (~10%). These companies export to 20+ countries and supply the majority of Iran\'s chronic therapy demand under IFDA price controls.' },
  { q: 'How does Iran compare to other MENA pharmaceutical markets?', a: 'Iran is second-largest in MENA by volume with ~95% local production — unlike Egypt or GCC markets that rely heavily on imports. For regional benchmarking see BioNixus guides on pharmaceutical companies in Egypt, Saudi Arabia, and the UAE, plus the MENA pharmaceutical market data hub.' },
];
