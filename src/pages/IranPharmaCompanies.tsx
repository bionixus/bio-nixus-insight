...
const faqItems = [
  ...
  { q: 'Who are the leading biosimilar manufacturers in Iran?', a: 'Sobhan Pharmaceutical (insulin), Cinnagen (EPO, insulin), and Exir Pharmaceutical (biosimilars, vaccines) are among Iran\'s leading biosimilar producers. Darou Pakhsh and Razak Laboratories supply large generic volumes with export reach to 20+ countries. Research programmes should map which local manufacturers compete in your molecule class before assuming import-led market entry.' },
  { q: 'How can foreign companies conduct pharmaceutical market research in Iran?', a: 'BioNixus provides market and competitive intelligence, IFDA pathway analysis, distributor mapping, and scenario planning for Iran without requiring on-the-ground promotional activity. Studies use publicly available data, expert interviews where feasible, and comparative MENA benchmarking — supporting strategic planning while sanctions and IFDA controls shape direct commercial engagement.' },
  { q: 'What is the role of Indian pharmaceutical suppliers in Iran?', a: 'Indian companies including Cipla, Dr. Reddy\'s, and Sun Pharma supply significant generic volumes to Iran, often through distributor partnerships under IFDA oversight. Competitive intelligence should include Indian export positioning, pricing under government-controlled IFDA ceilings, and substitution dynamics in hospital and retail channels.' },
];
