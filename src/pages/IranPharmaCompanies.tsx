...
const faqItems = [
  ...
  { q: 'What therapeutic areas dominate Iran\'s pharmaceutical market?', a: 'Oncology, diabetes, cardiovascular disease, and essential generics represent the largest volume segments. Biosimilar insulin and EPO production by Sobhan Pharmaceutical and Cinnagen anchors local innovation. Chronic disease prevalence across 88.6 million population sustains demand for metabolic, cardiovascular, and anti-infective therapies alongside government-funded essential medicines lists.' },
  { q: 'How does Iran\'s export-oriented pharma industry affect market research?', a: 'Iranian manufacturers such as Razak Laboratories export to 20+ countries, creating dual domestic-and-export strategic planning needs. Research programmes should map both IFDA-regulated domestic pricing and export market requirements when advising multinational portfolio teams evaluating Iran partnerships or competitive intelligence on regional generic supply.' },
  { q: 'What is the role of university–pharma research partnerships in Iran?', a: 'University–pharma research partnerships and the knowledge-based economy push support ongoing biosimilar and biologic development. Tehran University of Medical Sciences, Shahid Beheshti, and Isfahan University anchor clinical research activity. KOL mapping at these centres predicts national diffusion patterns for novel therapies and supports feasibility for physician and hospital stakeholder programmes.' },
];
        ...
        <section className="section-padding py-16 bg-muted/30" id="top-companies"><div className="container-wide max-w-5xl mx-auto">
          ...
          <div className="mt-8">
            <ConversionCTA
              ...
              headline="Get the full Iran ranked directory + market sizes (PDF)"
