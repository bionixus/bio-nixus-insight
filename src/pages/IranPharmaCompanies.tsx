...
const faqItems = [
  ...
  { q: 'Which therapy areas dominate Iran pharmaceutical demand?', a: 'Cardiovascular, diabetes, oncology, and essential medicines volumes dominate the Iranian market — with growing biosimilar and insulin portfolios from local manufacturers such as Sobhan and Cinnagen. Multinational innovative share remains limited by sanctions and pricing controls; research should segment by locally manufactured versus import-dependent categories.' },
  { q: 'How can foreign manufacturers research Iran without overstating accessible share?', a: 'BioNixus uses primary stakeholder research and desk structure to separate addressable import-dependent niches from categories already supplied by 180+ local manufacturers — avoiding inflated TAM figures that ignore government pricing and distribution controls.' },
];
