...
const faqItems = [
  ...
  { q: 'Which therapeutic areas drive Iran pharmaceutical growth in 2026?', a: 'Diabetes, oncology, cardiovascular disease, and biosimilar insulin/EPO categories remain the fastest-growing segments as local manufacturers expand capacity under import substitution policy. Hospital tenders through the Ministry of Health and Social Security Organization (SSO) channels still dominate volume, while private pharmacy chains grow share in chronic therapies and OTC.' },
  { q: 'How can international companies research the Iran market without on-the-ground teams?', a: 'BioNixus supports Iran-focused market access and competitive intelligence using verified distributor interviews, hospital pharmacist modules, and physician surveys where ethics and sampling allow — paired with public IFDA and industry association data. Programmes are scoped to your partnership model (local manufacturing, licensing, or distribution) and sanctions compliance requirements.' },
];
      ...
      <main>
        <LegacyDirectoryChrome
          breadcrumbs={[
            ...
            { name: 'Pharmaceutical Companies in Iran', href: '/pharmaceutical-companies-iran' },
          ]}
          h1="Pharmaceutical Companies in Iran"
          lead={
            <>
              Pharmaceutical companies in Iran represent the MENA region&apos;s second-largest pharma market by volume — for Gulf and global context see <Link to="/healthcare-market-research">healthcare market research</Link>. This guide covers major pharma companies, IFDA regulatory framework, 95% local production, market data, distribution channels, and strategic opportunities.
            </>
          }
          metaLine="Last updated: February 2026 · Sources: IFDA, industry reports, company filings"
          stats={[
            { value: '$4.2B', label: 'Pharmaceutical market value' },
            { value: '7.3%', label: 'Year-over-year growth' },
            { value: '88.6M', label: 'Population' },
            { value: '$47', label: 'Pharma spending per capita' },
          ]}
          jumpItems={[
          ...
          proposalLabel="Request an Iran proposal"
          citationUrl={citationUrl}
          citeHeadline="Pharmaceutical Companies in Iran: Complete Industry Guide 2026"
