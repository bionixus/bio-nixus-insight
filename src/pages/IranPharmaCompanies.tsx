...
const faqItems = [
  ...
  { q: 'Which therapeutic areas dominate Iran\'s pharmaceutical market?', a: 'Cardiovascular, diabetes, oncology, and infectious diseases account for the largest prescription volumes in Iran. Biosimilars (insulin, EPO, filgrastim) and locally manufactured generics dominate volume; specialty innovator medicines remain a smaller but growing import segment through distributors and limited MNC partnerships. Hospital and retail pharmacy channels both operate under IFDA price controls.' },
  { q: 'How does Iran compare to GCC pharmaceutical markets for exporters?', a: 'Iran differs sharply from GCC markets: ~95% local production versus heavy import dependency in most GCC states; IFDA government pricing versus ERP-based GCC pricing; and sanctions-limited direct MNC presence versus open distributor networks in Saudi Arabia and the UAE. Companies planning regional strategy should treat Iran as a distinct access model — see our GCC Pharmaceutical Market Access Guide for comparator registration and tender pathways.' },
];
