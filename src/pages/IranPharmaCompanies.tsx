...
const faqItems = [
  ...
  { q: 'Which Iranian pharmaceutical companies export to neighbouring markets?', a: 'Several Iranian manufacturers export generics and biosimilars to Iraq, Afghanistan, Central Asia, and parts of Africa despite sanctions complexity. Razak Laboratories reports exports to 20+ countries; Cinnagen and Sobhan supply insulin and biologics regionally. Export strategy research should map distributor credibility, currency settlement risk, and parallel regulatory recognition—areas BioNixus covers in cross-border MENA intelligence programmes.' },
  { q: 'How does Iran\'s government-controlled pricing affect innovator launch strategy?', a: 'IFDA sets maximum prices for registered medicines, which compresses margin for imported innovators and rewards local generic volume. Launch teams must model net price after mandatory discounts, hospital tender behaviour, and pharmacy mark-ups—not ex-factory list prices alone. BioNixus payer and pharmacist research clarifies where clinical demand exists despite pricing caps and which segments remain economically viable for partnership or licensing models.' },
];
