...
const faqItems = [
  ...
  { q: 'Which therapeutic areas dominate Iran pharmaceutical exports?', a: 'Iran exports generics, biosimilars, and selected biologics to neighbouring MENA markets and beyond — insulin, EPO, antibiotics, and OTC categories feature prominently. Export research should map which SKUs clear destination-country registration realistically rather than assuming domestic portfolio breadth travels unchanged.' },
  { q: 'How does IFDA pricing control affect multinational market entry?', a: 'Government-controlled pricing and distribution rules shape which innovative products enter via local partners versus remain import-only niches. BioNixus researches access pathways and partner requirements without substituting for legal sanctions or compliance advice.' },
];
