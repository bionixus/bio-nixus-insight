...
const faqItems = [
  ...
  { q: 'What export corridors matter for Iran pharmaceutical partnerships?', a: 'Iranian manufacturers such as Darou Pakhsh and Cinnagen export to 20+ countries across MENA and Central Asia. Partnership research should map which corridors tolerate dual sourcing, which require local repackaging, and how IFDA pricing caps affect net economics for regional licensees.' },
  { q: 'How can market research support Iran portfolio decisions under sanctions uncertainty?', a: 'Scenario-based research — local production depth, distributor concentration, and clinician substitution behaviour — helps teams stress-test launch, licensing, and divestment options without assuming a single political trajectory. BioNixus frames insights for medical and access governance rather than promotional claims.' },
];
