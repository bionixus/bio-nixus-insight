...
const faqItems = [
  ...
  { q: 'Who are the leading pharmaceutical distributors in Iran?', a: 'Darou Pakhsh Distribution, Hakim Distribution, and TPICO (Tehran Pharma Investment Co.) dominate national wholesale channels alongside manufacturer-owned logistics. Distribution reach and cold-chain capability often determine whether imported or locally manufactured brands achieve national coverage — especially outside Tehran. BioNixus maps distributor relationships and channel economics for partnership due diligence and launch sequencing.' },
  { q: 'How can foreign pharma companies research the Iran market under sanctions constraints?', a: 'Primary market research through verified physician, pharmacist, and hospital stakeholder interviews — conducted with compliance-aware protocols — remains valuable for regional HQ planning even when direct commercial operations are limited. BioNixus designs Iran modules that respect sanctions-sensitive engagement rules while capturing prescribing culture, local manufacturing competitiveness, and post-sanctions scenario planning for portfolio committees.' },
];
