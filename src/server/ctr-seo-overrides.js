...
export const CTR_SEO_BY_PATH = {
  ...
  '/insights/top-healthcare-market-research-companies-saudi-arabia-2026': {
    title: 'Top Healthcare Market Research Firms in Saudi Arabia (2026)',
    description:
      'Healthcare-only market research firms in Saudi Arabia — SFDA-aware rankings for NUPCO, Vision 2030 & Arabic HCP fieldwork. Compare BioNixus, IQVIA & peers.',
  },
  ...
  // CTR sprint wave 4 (2026-08-28): page-1 zero-click queries from GSC weekly export.
  '/japan-neurology-devices-market': {
    title: 'Japan Neurology Devices Market 2026: Size, PMDA & Forecast',
    description:
      'Japan neurology devices market 2026 — stroke intervention, neurosurgery, neuromonitoring, PMDA pathways and NHI category intelligence. By BioNixus.',
  },
  '/japan-medical-disposables-market': {
    title: 'Japan Medical Disposables Market 2026: Size & Procurement',
    description:
      'Japan medical disposables market 2026 — hospital consumables, infection-control products, tender dynamics and nursing workflow intelligence. By BioNixus.',
  },
  '/japan-general-surgical-devices-market': {
    title: 'Japan General Surgical Devices Market 2026 | BioNixus',
    description:
      'Japan general surgical devices market 2026 — OR capital, laparoscopic platforms, PMDA/NHI access and hospital procurement intelligence. By BioNixus.',
  },
  '/pharmaceutical-market-research-dubai': {
    title: 'Pharmaceutical Companies in Dubai (2026 Ranked List) | BioNixus',
    description:
      'Pharmaceutical companies in Dubai UAE 2026 — ranked list of pharma firms, MOHAP/DHA licensing, DIFC clusters and market research for Dubai launches. By BioNixus.',
  },
  '/healthcare-market-research-turkey': {
    title: 'Turkey Diabetes & Healthcare Market Research 2026 | BioNixus',
    description:
      'Turkey diabetes market and healthcare market research 2026 — TITCK regulation, SGK reimbursement, endocrinologist panels and launch intelligence. By BioNixus.',
  },
  '/middle-east-biologics-market': {
    title: 'GCC Biologics Market 2026: Size, Biosimilars & Access',
    description:
      'GCC biologics market 2026 — biosimilar uptake, SFDA/MOHAP tenders, payer HTA and biologics access intelligence across Saudi, UAE and Gulf states. By BioNixus.',
  },
  '/gcc-functional-service-providers-market': {
    title: 'GCC Functional Service Providers Market 2026 | BioNixus',
    description:
      'GCC functional service providers (FSP/CRO) market 2026 — clinical operations outsourcing, Saudi/UAE trial demand and vendor selection intelligence. By BioNixus.',
  },
  '/insights/top-market-research-companies-egypt-2026': {
    title: 'Top Market Research Companies in Egypt (2026) | Kantar Alternatives',
    description:
      'Market research companies in Egypt 2026 — ranked guide vs Kantar, GfK and regional firms. Cairo fieldwork, EDA pharma context and healthcare research by BioNixus.',
  },
};
