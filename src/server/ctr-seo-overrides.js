...
export const CTR_SEO_BY_PATH = {
  ...
  // CTR wave 6 (2026-08-30): page-1 queries @ 0% CTR from GSC weekly export.
  '/biosimilar-market-entry-saudi-arabia': {
    title: 'Saudi Arabia Biosimilar Market 2026: SFDA, NUPCO & Entry Guide',
    description:
      'Saudi Arabia biosimilar market 2026 — SFDA registration pathways, NUPCO tender frameworks, physician adoption research & GCC launch sequencing. Strategy guide by BioNixus.',
  },
  '/market-reports/gcc-biosimilars-market-report': {
    title: 'GCC Biologics & Biosimilars Market 2026: Size & Access',
    description:
      'GCC biologics market 2026 — immunology, oncology & biosimilar competition, SFDA/MOHAP access, NUPCO tender dynamics & Gulf hospital frameworks. Report by BioNixus.',
  },
  '/market-reports/turkey-diabetes-market-report': {
    title: 'Turkey Diabetes Market 2026: Size, SGK & GLP-1 Access',
    description:
      'Turkey diabetes market 2026 — metabolic disease prevalence, SGK vs private GLP-1 access, Istanbul vs Anatolia referral patterns. Market report by BioNixus.',
  },
  '/singapore-ivd-market-access': {
    title: 'Singapore IVD Market Access 2026: HSA, Lab & Hospital Guide',
    description:
      'Singapore IVD market access 2026 — HSA pathways, cluster lab procurement, pathology algorithms & hospital adoption research. By BioNixus.',
  },
  '/market-reports/gcc-vaccines-market-report': {
    title: 'GCC Vaccine Market 2026: Size, Tenders & Hajj Demand',
    description:
      'GCC vaccine market 2026 — conjugate tenders, Hajj meningococcal demand, immunization programmes & country forecasts across the Gulf. Report by BioNixus.',
  },
  '/bionixus-vs-iqvia-mena': {
    title: 'IQVIA Competitors MENA: BioNixus vs IQVIA Compared (2026)',
    description:
      'IQVIA competitors for MENA healthcare research — BioNixus vs IQVIA on primary research, hospital data, GCC fieldwork & market access. Side-by-side 2026 guide.',
  },
  '/healthcare-market-research/saudi-arabia': {
