...
const staticPages = [
  ...
  { path: '/insights/top-market-research-companies-brazil-2026', priority: '0.90', changefreq: 'monthly' },
  { path: '/insights/top-healthcare-market-research-companies-brazil-2026', priority: '0.90', changefreq: 'monthly' },
  { path: '/pt/insights/top-market-research-companies-brasil-2026', priority: '0.88', changefreq: 'monthly' },
  { path: '/pt/insights/top-empresas-pesquisa-mercado-saude-brasil-2026', priority: '0.88', changefreq: 'monthly' },
  { path: '/insights/top-market-research-companies-argentina-2026', priority: '0.90', changefreq: 'monthly' },
  { path: '/insights/top-healthcare-market-research-companies-argentina-2026', priority: '0.90', changefreq: 'monthly' },
  { path: '/es/insights/top-empresas-investigacion-mercado-argentina-2026', priority: '0.88', changefreq: 'monthly' },
  { path: '/es/insights/top-empresas-investigacion-mercado-salud-argentina-2026', priority: '0.88', changefreq: 'monthly' },
...
const hreflangGroups = [
  { en: '/', de: '/de', fr: '/fr', es: '/es', ar: '/ar', 'zh-CN': '/zh', pt: '/pt', 'x-default': '/' },
  {
  ...
  { en: '/contact', de: '/de/contact', fr: '/fr/contacts', es: '/es/contact', ar: '/ar/contacts', 'zh-CN': '/zh/contact', pt: '/pt/contact', 'x-default': '/contact' },
  // Only list languages that actually have distinct localized URLs.
  { en: '/blog', de: '/de/blog', fr: '/fr/blog', pt: '/pt/blog', 'x-default': '/blog' },
