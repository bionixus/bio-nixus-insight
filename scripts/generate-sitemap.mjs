...
const staticPages = [
  ...
  // Country healthcare market report pages (standalone report pages, separate from /healthcare-market-research/* hub)
...
// so dedupe by the group's signature.
{
  const seen = new Set();
  for (const page of topCompaniesManifest) {
    const group = {};
