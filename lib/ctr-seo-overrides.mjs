...
export const CTR_SEO_BY_PATH = {
  ...
  '/insights/top-healthcare-market-research-companies-saudi-arabia-2026': {
    title: '5 Best Healthcare Market Research Firms in Saudi Arabia (2026)',
    description:
      'Healthcare market research companies Saudi Arabia 2026 — SFDA-aware firms ranked for NUPCO, Vision 2030 & Arabic HCP fieldwork. Compare BioNixus, IQVIA & peers.',
  },
  ...
  '/healthcare-market-research-italy': {
    title: 'Healthcare Market Research Italy 2026 | AIFA & IRCCS | BioNixus',
    description:
      'Healthcare market research Italy 2026 — AIFA CTS/CPR payer studies, IRCCS KOL mapping, SSR regional formulary research and Italian-language HCP fieldwork by BioNixus.',
  },
  '/bionixus-vs-iqvia-mena': {
    title: 'BioNixus vs IQVIA MENA (2026) | Hospital Data & Primary Research',
    description:
      'BioNixus vs IQVIA for MENA healthcare research 2026 — hospital consumption data, agile primary research, and GCC/Egypt depth compared side by side.',
  },
  '/services': {
    title: 'Market Research Services 2026 | Pharma, Healthcare & B2B | BioNixus',
    description:
      'Market research services for pharma, healthcare, MedTech, and commercial industries — CATI, CAWI, CAPI, KOL mapping, and market access across 38 countries. Request a proposal.',
  },
  '/brazil-pharmaceutical-market-research': {
    title: 'Pharmaceutical Market Research Brazil 2026 | ANVISA | BioNixus',
    description:
      'Pharmaceutical market research Brazil 2026 — ANVISA-aware HCP surveys, CONITEC payer context, Portuguese fieldwork and LATAM launch intelligence by BioNixus.',
  },
};
