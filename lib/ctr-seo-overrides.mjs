...
export const CTR_SEO_BY_PATH = {
  ...
  '/iqvia-alternative': {
    // CTR iterate 2026-09-22: head query "iqvia competitors" @ ~pos 6, 0% CTR — lead with competitors keyword.
    title: 'IQVIA Competitors & Alternatives: Top 10 Ranked (2026)',
    description:
      'IQVIA competitors and companies like IQVIA for healthcare market research in 2026 — primary research vs syndicated data, ranked alternatives, and when to stay with IQVIA.',
  },
  ...
  '/gcc-functional-service-providers-market': {
    ...
    description:
      'GCC functional service providers market 2026 — FSP vs full-service CRO, monitoring & PV demand in Saudi Arabia and UAE, sponsor buyer criteria. By BioNixus.',
  },
  ...
  '/febrile-neutropenia-market': {
    ...
    description:
      'Febrile neutropenia market 2026 — G-CSF prophylaxis protocols, biosimilar switching, hospital tenders, and oncology pharmacy research. By BioNixus.',
  },
