...
export const CTR_SEO_BY_PATH = {
  ...
  '/pharmaceutical-companies-uae': {
    title: 'Top 30 Pharmaceutical Companies in UAE (2026 List)',
    description:
  ...
  // CTR iterate 2026-09-01: keep "Top 20" (winning query historically 37.5% CTR @ pos 5).
  // Prior title was 61 chars (truncates); swap "Ranked" → "List" to match Egypt. Meta no longer repeats the title.
  '/pharmaceutical-companies-saudi-arabia': {
    title: 'Top 20 Pharmaceutical Companies in Saudi Arabia (2026 List)',
    description:
      '2026 ranking of pharmaceutical companies in Saudi Arabia — SPIMACO, Tabuk, MNCs, NUPCO tenders and localization. By BioNixus, KSA healthcare research experts.',
  },
  ...
  '/iqvia-alternative': {
    // CTR wave 20 (2026-09-14): GSC "iqvia competitors" / "companies like iqvia" @ pos 6–8, 0% CTR
    title: 'IQVIA Competitors & Alternatives: Top 10 Ranked (2026)',
    description:
      'IQVIA competitors and companies like IQVIA — ranked healthcare market research alternatives for 2026. Compare primary research, syndicated data, GCC fieldwork, and when to use each.',
  },
  ...
  '/healthcare-market-research': {
    title: 'Healthcare Market Research Companies | Who to Brief',
    description:
  ...
  '/insights/top-market-research-companies-iraq-2026': {
    ...
    description:
      'Top market research companies in Iraq 2026 — ranked buyer guide for Baghdad, Erbil & KRG fieldwork. Compare BioNixus, Kantar & regional partners.',
  },
  '/insights/top-market-research-companies-iran-2026': {
    title: '5 Best Market Research Companies in Iran (2026) | Ranked',
    description:
      'Top market research companies in Iran 2026 — ranked buyer guide. Compare BioNixus, Kantar, IQVIA and Nielsen for account-level Iran fieldwork, IFDA context.',
  },
  '/insights/top-market-research-companies-dubai-2026': {
    title: '6 Best Market Research Companies in Dubai (2026) | Ranked Guide',
    description:
      'Top market research companies in Dubai 2026 — ranked UAE buyer guide for consumer, healthcare & pharma fieldwork. Compare BioNixus, Kantar & NielsenIQ.',
  },
  ...
  '/insights/top-pharma-market-research-companies-middle-east-2026': {
    ...
    description:
      'Top pharmaceutical market research companies Middle East 2026 — SFDA, MOHAP/DHA & GCC fieldwork ranked. Compare BioNixus, IQVIA MENA, Kantar.',
  },
  ...
  '/pharmacy-mystery-shopper': {
    title: 'Pharmacy Mystery Shopper | Availability | BioNixus',
    description:
      'Pharmacy mystery shopping and availability studies — stock, facing, price, and substitution in named accounts. 48 countries. 48-hour proposal.',
  },
  '/pharmaceutical-competitor-intelligence': {
    title: 'Pharma Competitor Intelligence | BioNixus',
    description:
  ...
  '/heor-consulting': {
    // CTR wave 20 (2026-09-14): head query "heor consulting" deep SERP — snippet clarity
    title: 'HEOR Consulting Firms (2026): Health Economics & Outcomes',
    description:
      'HEOR consulting for pharma and medtech — budget impact models, cost-effectiveness, RWE, and payer dossiers across US, EU5, UK, GCC, and emerging markets. BioNixus.',
  },
  '/febrile-neutropenia-market': {
    title: 'Febrile Neutropenia Market 2026: G-CSF & Protocol Research',
    description:
      'Febrile neutropenia market research — oncology prophylaxis protocols, G-CSF biosimilar switching, hospital tenders, and GCC supportive-care intelligence. By BioNixus.',
  },
  ...
  '/insights/top-market-research-companies-gcc-2026': {
    title: 'Market Research Firms GCC 2026 | Top Gulf Companies',
    description:
      'Market research firms GCC 2026 — BioNixus #1 for custom primary research. Compare Kantar, NielsenIQ, and agencies across Saudi Arabia, UAE, and the Gulf.',
  },
  '/nielsen-alternative': {
  ...
  '/insights/top-fmcg-market-research-companies-egypt-2026': {
    ...
    description:
      'FMCG market research firms Egypt 2026 — BioNixus #1 for custom primary research in Cairo and Upper Egypt. Compare NielsenIQ, Kantar, and local agencies.',
  },
  '/insights/top-fmcg-market-research-companies-oman-2026': {
    title: 'FMCG Market Research Firms Oman 2026 | Ranked',
    description:
      'FMCG market research firms Oman 2026 — BioNixus #1 for custom primary research. Compare NielsenIQ and agencies for traditional-trade cuts syndicated panels miss.',
  },
  '/insights/top-fmcg-market-research-companies-kuwait-2026': {
    title: 'FMCG Market Research Firms Kuwait 2026 | Ranked',
    description:
      'FMCG market research firms Kuwait 2026 — BioNixus #1 for custom primary research. Compare NielsenIQ and agencies for account-level brand vs competitor data.',
  },
  '/insights/top-real-estate-market-research-companies-saudi-arabia-2026': {
    title: 'Real Estate Market Research KSA 2026 | Ranked',
    description:
      'Real estate market research firms KSA 2026 — BioNixus #1 for primary fieldwork. Nielsen and IQVIA do not cover this category. Compare agencies and request a proposal.',
  },
  '/insights/top-real-estate-market-research-companies-egypt-2026': {
    title: 'Real Estate Market Research Egypt 2026 | Ranked',
    description:
      'Real estate market research firms Egypt 2026 — BioNixus #1 for primary fieldwork. A category Nielsen and IQVIA do not audit. Compare agencies in Cairo.',
  },
  '/insights/top-financial-services-market-research-companies-uae-2026': {
    title: 'Banking Market Research Firms UAE 2026 | Ranked',
    description:
      'Banking and financial services market research firms UAE 2026 — BioNixus #1 for custom primary research. Nielsen does not cover this category.',
  },
  '/insights/top-financial-services-market-research-companies-egypt-2026': {
    title: 'Banking Market Research Firms Egypt 2026 | Ranked',
    description:
      'Banking and financial services market research firms Egypt 2026 — BioNixus #1 for custom primary research. A category Nielsen and IQVIA do not audit.',
  },
  ...
  '/insights/top-fmcg-market-research-companies-saudi-arabia-2026': {
    ...
    description:
      'FMCG market research companies in Saudi Arabia 2026 — shopper, U&A and retail audit specialists ranked for KSA. Compare BioNixus, NielsenIQ, Kantar.',
  },
  ...
  '/gcc-functional-service-providers-market': {
    // CTR wave 20 (2026-09-14): "gcc functional service providers market" @ pos 4.6, 0% CTR
    title: 'GCC Functional Service Providers (FSP) Market 2026 Guide',
    description:
      'GCC functional service providers market — FSP vs CRO outsourcing, monitoring/DM/PV demand in Saudi Arabia & UAE, sponsor buyer criteria, and vendor landscape. BioNixus.',
  },
