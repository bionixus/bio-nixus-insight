...
export const CTR_SEO_BY_PATH = {
  ...
  '/pharmaceutical-companies-uae': {
    title: 'Top 30 Pharma Companies in Dubai & UAE (2026 Ranked)',
    description:
      'Pharmaceutical companies in Dubai & UAE ranked for 2026 — manufacturers, distributors, market size and MOHAP context. The definitive Dubai pharma company list by BioNixus.',
  },
  ...
  '/iqvia-alternative': {
    ...
    title: 'IQVIA Competitors & Alternatives: 10 Ranked (2026)',
    description:
      'IQVIA competitors and companies like IQVIA ranked for healthcare market research in 2026 — when BioNixus wins on primary research vs when IQVIA syndicated data still fits.',
  },
  ...
  '/bionixus-vs-iqvia-mena': {
    title: 'BioNixus vs IQVIA MENA: Competitors Compared (2026)',
    description:
      'IQVIA competitors in MENA & GCC compared side-by-side — hospital data, primary research, speed and pricing. When BioNixus wins vs when IQVIA syndicated data fits.',
  },
};
