...
export const CTR_SEO_BY_PATH = {
  ...
  '/pharmaceutical-companies-iran': {
    title: 'Pharmaceutical Companies in Iran: 2026 Ranked List & Market Size',
    description:
      'Top pharmaceutical companies in Iran ranked for 2026 — local manufacturers, biosimilars, IFDA regulation, and market size (~$4.5B). Research by BioNixus.',
  },
  '/pharmaceutical-companies-iraq': {
    title: 'Pharmaceutical Companies in Iraq: 2026 List, KIMADIA & Market Size',
    description:
      'Top pharmaceutical companies in Iraq ranked 2026 — KIMADIA tenders, import structure, and $2B+ market data. Research by BioNixus.',
  },
  ...
  '/turkey-healthcare-market-report': {
    title: 'Turkey Healthcare Market Report 2026: Size, TITCK & Pharma Outlook',
    description:
      'Turkey healthcare and pharmaceutical market 2026 — market size, TITCK regulation, hospital procurement, and growth forecast. Report by BioNixus.',
  },
  '/bionixus-vs-iqvia-mena': {
    title: 'BioNixus vs IQVIA MENA (2026): When to Choose Each',
    description:
      'Compare BioNixus and IQVIA for GCC healthcare research — hospital data, primary fieldwork, speed, and when each wins. MENA specialist vs global syndicated data.',
  },
  '/brazil-pharmaceutical-market-research': {
    title: 'Brazil Pharmaceutical Market Research 2026 | ANVISA & CONITEC',
    description:
      'Brazil pharmaceutical market research — ANVISA-aware HCP surveys, CONITEC HEOR, SUS vs private payer studies. Primary research by BioNixus.',
  },
  '/healthcare-market-research-italy': {
    title: 'Healthcare Market Research Italy 2026 | AIFA & Regional HTA',
    description:
      'Pharmaceutical market research in Italy — AIFA registration context, regional HTA, hospital formulary research, and KOL mapping by BioNixus.',
  },
};
