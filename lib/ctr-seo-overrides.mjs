...
export const CTR_SEO_BY_PATH = {
  ...
  '/pharmaceutical-companies-uae': {
    title: 'Top 30 Pharmaceutical Companies in Dubai & UAE (2026)',
    description:
      'Complete 2026 ranked list of pharmaceutical companies in Dubai & UAE — manufacturers, distributors, market size and MOHAP regulation. By Bionixus, GCC pharma research specialists.',
  },
  ...
  '/bionixus-vs-iqvia-mena': {
    title: 'IQVIA Competitors in MENA: BioNixus vs IQVIA (2026)',
    description:
      'IQVIA competitors in MENA and GCC ranked — BioNixus vs IQVIA for hospital data, primary research, and market access. Companies like IQVIA compared for Saudi Arabia and UAE.',
  },
  '/pharmaceutical-companies-iran': {
    title: 'Top 18 Pharmaceutical Companies in Iran (2026 Ranked List)',
    description:
      'Top 18 pharmaceutical companies in Iran ranked for 2026 — $4.2B market, IFDA regulation, biosimilars and 95% local production. By BioNixus.',
  },
  '/pharmaceutical-companies-iraq': {
    title: 'Top Pharmaceutical Companies in Iraq (2026 KIMADIA Guide)',
    description:
      'Top pharmaceutical companies in Iraq ranked for 2026 — KIMADIA tenders, $2.8B market, MNC offices and KRG access pathways. Research by BioNixus.',
  },
};
