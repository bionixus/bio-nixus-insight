...
export const CTR_SEO_BY_PATH = {
  ...
  '/bionixus-vs-iqvia-mena': {
    title: 'BioNixus vs IQVIA MENA (2026): Data Depth & Primary Research',
    description:
      'IQVIA alternatives in MENA and GCC — compare hospital consumption data, physician research, and market access support. When BioNixus wins vs IQVIA syndicated audits.',
  },
  '/services': {
    title: 'Healthcare Market Research Services (2026) | BioNixus',
    description:
      'Pharma market research services — quantitative HCP surveys, qualitative depth, KOL mapping, market access, and cross-industry fieldwork across 38 countries. Request a proposal.',
  },
  '/bionixus-market-research-middle-east': {
    title: 'Middle East Pharmaceutical Market Research (2026) | BioNixus',
    description:
      'Pharmaceutical market research Middle East — Saudi, UAE, Egypt, Kuwait, Qatar fieldwork, NUPCO/SFDA context, and primary research without IQVIA enterprise minimums.',
  },
  '/gcc-market-access-guide': {
    title: 'GCC Market Access Guide 2026: SFDA, MOHAP & Pricing',
    description:
      'GCC pharmaceutical market access — registration timelines, ERP pricing, NUPCO tenders, and country-by-country SFDA/MOHAP requirements. Free guide by BioNixus.',
  },
  '/brazil-healthcare-market-research': {
    title: 'Brazil Healthcare Market Research (2026) | BioNixus',
    description:
      'Healthcare market research Brazil — ANVISA-aware HCP surveys, retail pharmacy channels, and São Paulo field networks for pharma and MedTech teams.',
  },
  '/healthcare-market-research/therapy/digital-health': {
    title: 'Digital Health Market Research | SaMD & Remote Monitoring',
    description:
      'Digital health market research for pharma and MedTech — clinician adoption, payer readiness, EHR integration friction, and procurement scoring across GCC, UK, and EU5.',
  },
  '/healthcare-market-research/therapy/neurology-cns': {
    title: 'Neurology & CNS Market Research | BioNixus',
    description:
      'Neurology and CNS market research — diagnostic delay, infusion logistics, caregiver burden, and access gates for MS, epilepsy, and neurodegenerative franchises.',
  },
};
