...
export const CTR_SEO_BY_PATH = {
  ...
  '/bionixus-vs-iqvia-mena': {
    title: 'BioNixus vs IQVIA MENA Research (2026) | BioNixus',
    description:
      'Compare BioNixus and IQVIA for MENA healthcare research — hospital sales data, consumption analytics, GCC fieldwork, and market access without enterprise minimums.',
  },
