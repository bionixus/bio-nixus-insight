...
export const CTR_SEO_BY_PATH = {
  ...
  '/pharmaceutical-companies-iran': {
    ...
    description:
      'Top pharmaceutical companies in Iran ranked for 2026 — $4.2B market, 180+ local manufacturers, IFDA registration and biosimilar leaders. Guide by BioNixus.',
  },
  '/pharmaceutical-companies-iraq': {
    title: 'Top Pharmaceutical Companies in Iraq (2026 KIMADIA Guide)',
    description:
      'Pharmaceutical companies in Iraq 2026 — KIMADIA tenders, KRG dual market, top manufacturers, MNC offices and $2.8B market context. By BioNixus.',
  },
  ...
  '/brazil-healthcare-market-report': {
    title: 'Brazil Healthcare Market 2026: ANVISA, SUS & $165B Outlook',
    description:
      'Brazil healthcare market 2026 — $165B market size, ANVISA regulation, SUS/CONITEC access, ANS private sector and pharma outlook. Report by BioNixus.',
  },
  ...
  '/gcc-market-access-guide': {
    title: 'GCC Market Access 2026: Pharma Registration, Pricing & NUPCO',
    description:
      'GCC pharmaceutical market access 2026 — SFDA, MOHAP, DHA registration, ERP pricing, NUPCO tenders and biosimilar HTA evidence. Free guide by BioNixus.',
  },
  ...
  // CTR sprint wave 7 (2026-08-31): page-1 zero-click queries from weekly GSC audit.
  '/japan-general-surgical-devices-market': {
    title: 'Japan General Surgical Devices Market 2026: OR & NHI Guide',
    description:
      'Japan general surgical devices market 2026 — stapling, energy, laparoscopy adoption, PMDA/NHI pricing and hospital OR procurement intelligence. By BioNixus.',
  },
};
