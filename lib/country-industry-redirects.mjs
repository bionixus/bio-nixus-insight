...
/**
 * Standalone pages whose paths match LEGACY_PATH but must serve at their canonical URL.
 * Keep in sync with src/routes.tsx and vercel.json service redirects.
 */
