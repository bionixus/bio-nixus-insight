...
/** Canonical standalone pages that match `{slug}-{industry}-market-research` but are not legacy country BOFU URLs. */
const STANDALONE_MARKET_RESEARCH_PATHS = new Set([
...
export function resolveLegacyCountryIndustryMarketResearchRedirect(pathname) {
  if (STANDALONE_MARKET_RESEARCH_PATHS.has(pathname)) return null;
