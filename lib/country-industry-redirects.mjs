...
/**
 * Standalone BOFU URLs that match `{country}-{industry}-market-research` but must not redirect.
 * Keep in sync with React Router routes and vercel.json canonical paths.
 */
