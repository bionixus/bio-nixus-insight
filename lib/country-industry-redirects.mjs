...
/**
 * Standalone BOFU pages that match `{prefix}-{industry}-market-research` but must NOT
 * redirect to `/healthcare-market-research/{prefix}` (avoids loops with vercel.json).
 */
