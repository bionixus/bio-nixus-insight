...
/**
 * Standalone BOFU pages that match `{token}-healthcare-market-research` but must NOT
 * redirect to `/healthcare-market-research/{token}` (would loop with vercel.json aliases).
 */
