...
/**
 * Canonical marketing URLs that match `{prefix}-healthcare-market-research` but must not
 * redirect to `/healthcare-market-research/{prefix}` (would loop with vercel.json aliases).
 */
export const STANDALONE_LEGACY_EXCLUSIONS = new Set(['/quantitative-healthcare-market-research']);
