...
/**
 * Standalone BOFU pages that match `{country}-{industry}-market-research` but must
 * NOT redirect to `/healthcare-market-research/{country}`.
 * Keep in sync with src/routes.tsx canonical paths.
 */
