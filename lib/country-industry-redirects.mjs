...
/**
 * Standalone service pages whose slugs match LEGACY_PATH but must serve at their canonical URL.
 * Without this guard, `/quantitative-healthcare-market-research` loops with vercel.json
 * (`/healthcare-market-research/quantitative` ↔ `/quantitative-healthcare-market-research`).
 */
const STANDALONE_LEGACY_EXCLUSIONS = new Set([
