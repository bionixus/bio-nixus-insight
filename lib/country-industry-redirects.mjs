...
/**
 * Canonical standalone BOFU URLs that match `{prefix}-{industry}-market-research` but must
 * NOT be rewritten to `/healthcare-market-research/{prefix}` (would conflict with vercel.json
 * hub redirects and cause loops — e.g. quantitative-healthcare-market-research).
 */
export const STANDALONE_LEGACY_EXCLUSIONS = new Set([
