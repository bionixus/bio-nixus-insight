...
/**
 * Canonical marketing URLs that match LEGACY_PATH but must be served (not redirected).
 * Example: `/quantitative-healthcare-market-research` would otherwise map to
 * `/healthcare-market-research/quantitative`, which Vercel redirects back — infinite loop.
 */
const STANDALONE_LEGACY_EXCLUSIONS = new Set(['/quantitative-healthcare-market-research']);
...
export function resolveLegacyCountryIndustryMarketResearchRedirect(pathname) {
  if (STANDALONE_LEGACY_EXCLUSIONS.has(pathname)) return null;
