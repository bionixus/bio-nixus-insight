...
/**
 * Standalone guide/BOFU paths that match LEGACY_PATH but must be served at their
 * canonical URL (not redirected to /healthcare-market-research/{slug}).
 * Keep in sync with src/routes.tsx dedicated pages.
 */
