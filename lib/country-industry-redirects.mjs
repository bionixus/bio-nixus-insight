...
/**
 * Standalone service pages whose paths match LEGACY_PATH but must not redirect to
 * `/healthcare-market-research/{slug}` (would loop with vercel.json canonical redirects).
 */
