...
/**
 * Canonical standalone pages that match the legacy `{country}-{industry}-market-research`
 * URL shape but must NOT be redirected to `/healthcare-market-research/{slug}`.
 * Keep in sync with dedicated guide routes in src/routes.tsx.
 */
