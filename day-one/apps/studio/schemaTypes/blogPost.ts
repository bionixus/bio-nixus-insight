...
export const blogPost = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      options: {
        list: [
          ...
          { title: 'B2B Market Research', value: 'B2B Market Research' },
          { title: 'B2C Market Research', value: 'B2C Market Research' },
          { title: 'FMCG & Retail', value: 'FMCG & Retail' },
          { title: 'Technology & Enterprise', value: 'Technology & Enterprise' },
    ...
    defineField({
      ...
      type: 'string',
      description:
        'Healthcare posts appear on the homepage and /blog. Industries posts appear on /bionixus-industries/insights only.',
      initialValue: 'healthcare',
      options: {
        list: [
          { title: 'Healthcare (homepage + /blog)', value: 'healthcare' },
          { title: 'Industries (B2B/B2C insights hub)', value: 'industries' },
        ],
        layout: 'radio',
      },
      validation: (Rule) => Rule.required(),
    ...
    defineField({
      ...
      type: 'string',
      description: 'Required for industries silo posts.',
      hidden: ({ parent }) => parent?.contentSilo !== 'industries',
      options: {
        list: [
          { title: 'B2B', value: 'b2b' },
          { title: 'B2C', value: 'b2c' },
    ...
    defineField({
      ...
      type: 'string',
      description: 'Links this article to country × industry BOFU pages on the site.',
      hidden: ({ parent }) => parent?.contentSilo !== 'industries',
      options: {
        list: [
          { title: 'Technology', value: 'technology' },
          { title: 'Energy & Industrials', value: 'energy' },
